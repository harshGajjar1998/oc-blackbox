...
Blackbox AI is also available as a desktop application. Download directly from the [releases page](https://github.com/anomalyco/blackbox ai/releases) or [blackbox.ai/download](https://www.blackbox.ai/download).
...
1. `$BLACKBOX_AI_INSTALL_DIR` - Custom installation directory
2. `$XDG_BIN_DIR` - XDG Base Directory Specification compliant path
3. `$HOME/bin` - Standard user binary directory (if it exists or can be created)
4. `$HOME/.blackbox ai/bin` - Default fallback
...
Learn more about [agents](https://www.blackbox.ai/docs/agents).

### Documentation

For more info on how to configure Blackbox AI, [**head over to our docs**](https://www.blackbox.ai/docs).
...
- 100% open source
- Not coupled to any provider. Although we recommend the models we provide through [Blackbox AI Zen](https://www.blackbox.ai/zen), Blackbox AI can be used with Claude, OpenAI, Google, or even local models. As models evolve, the gaps between them will close and pricing will drop, so being provider-agnostic is important.
