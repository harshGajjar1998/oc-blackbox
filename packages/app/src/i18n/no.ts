...
export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller levert av Blackbox",
  ...
  "provider.connect.apiKey.description":
    "Skriv inn din {{provider}} API-nøkkel for å koble til kontoen din og bruke {{provider}}-modeller i Blackbox.",
  ...
  "provider.connect.blackbox.line1":
    "Blackbox gir deg tilgang til et utvalg av pålitelige optimaliserte modeller for kodeagenter.",
  "provider.connect.blackbox.line2":
    "Med én enkelt API-nøkkel får du tilgang til modeller som Claude, GPT, Gemini, GLM og flere.",
  "provider.connect.blackbox.visit.prefix": "Besøk ",
  "provider.connect.blackbox.visit.link": "blackbox.ai",
  "provider.connect.blackbox.visit.suffix": " for å hente API-nøkkelen din.",
  "provider.connect.oauth.code.visit.prefix": "Besøk ",
  "provider.connect.oauth.code.visit.link": "denne lenken",
  "provider.connect.oauth.code.visit.suffix":
    " for å hente autorisasjonskoden din for å koble til kontoen din og bruke {{provider}}-modeller i Blackbox.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og skriv inn koden nedenfor for å koble til kontoen din og bruke {{provider}}-modeller i Blackbox.",
  ...
  "dialog.plugins.empty": "Plugins konfigurert i blackbox.json",
  ...
  "dialog.server.description": "Bytt hvilken Blackbox-server denne appen kobler til.",
  ...
  "toast.update.description": "En ny versjon av Blackbox ({{version}}) er nå tilgjengelig for installasjon.",
  ...
  "error.page.report.prefix": "Vennligst rapporter denne feilen til Blackbox-teamet",
  ...
  "error.chain.checkConfig": "Sjekk leverandør-/modellnavnene i konfigurasjonen din (blackbox.json)",
  "error.chain.mcpFailed": 'MCP-server "{{name}}" mislyktes. Merk at Blackbox ikke støtter MCP-autentisering ennå.',
  ...
  "sidebar.gettingStarted.line1": "Blackbox inkluderer gratis modeller så du kan starte umiddelbart.",
  ...
  "settings.desktop.wsl.description": "Kjør Blackbox-serveren i WSL på Windows.",
  ...
  "settings.general.row.language.description": "Endre visningsspråket for Blackbox",
  "settings.general.row.appearance.title": "Utseende",
  "settings.general.row.appearance.description": "Tilpass hvordan Blackbox ser ut på enheten din",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tilpass hvordan Blackbox er tematisert.",
  ...
  "settings.updates.row.startup.description": "Se automatisk etter oppdateringer når Blackbox starter",
  ...
  "settings.updates.toast.latest.description": "Du bruker den nyeste versjonen av Blackbox.",
