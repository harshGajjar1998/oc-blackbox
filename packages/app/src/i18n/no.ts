...
export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller levert av Blackbox AI",
  ...
  "provider.connect.apiKey.description":
    "Skriv inn din {{provider}} API-nøkkel for å koble til kontoen din og bruke {{provider}}-modeller i Blackbox AI.",
  ...
  "provider.connect.opencodeZen.line1":
    "Blackbox AI Zen gir deg tilgang til et utvalg av pålitelige optimaliserte modeller for kodeagenter.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " for å hente autorisasjonskoden din for å koble til kontoen din og bruke {{provider}}-modeller i Blackbox AI.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og skriv inn koden nedenfor for å koble til kontoen din og bruke {{provider}}-modeller i Blackbox AI.",
  ...
  "dialog.server.description": "Bytt hvilken Blackbox AI-server denne appen kobler til.",
  ...
  "toast.update.description": "En ny versjon av Blackbox AI ({{version}}) er nå tilgjengelig for installasjon.",
  ...
  "error.page.report.prefix": "Vennligst rapporter denne feilen til Blackbox AI-teamet",
  ...
  "error.chain.mcpFailed": 'MCP-server "{{name}}" mislyktes. Merk at Blackbox AI ikke støtter MCP-autentisering ennå.',
  ...
  "sidebar.gettingStarted.line1": "Blackbox AI inkluderer gratis modeller så du kan starte umiddelbart.",
  ...
  "settings.desktop.wsl.description": "Kjør Blackbox AI-serveren i WSL på Windows.",
  ...
  "settings.general.row.language.description": "Endre visningsspråket for Blackbox AI",
  "settings.general.row.appearance.title": "Utseende",
  "settings.general.row.appearance.description": "Tilpass hvordan Blackbox AI ser ut på enheten din",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tilpass hvordan Blackbox AI er tematisert.",
  ...
  "settings.updates.row.startup.description": "Se automatisk etter oppdateringer når Blackbox AI starter",
  ...
  "settings.updates.toast.latest.description": "Du bruker den nyeste versjonen av Blackbox AI.",
