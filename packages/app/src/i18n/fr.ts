export const dict = {
  ...
  "dialog.provider.blackbox.note": "Modèles sélectionnés incluant Claude, GPT, Gemini et plus",
  ...
  "dialog.model.unpaid.freeModels.title": "Modèles gratuits fournis par Blackbox",
  ...
  "provider.connect.apiKey.description":
    "Entrez votre clé API {{provider}} pour connecter votre compte et utiliser les modèles {{provider}} dans Blackbox.",
  ...
  "provider.connect.blackbox.line1":
    "Blackbox vous donne accès à un ensemble sélectionné de modèles fiables et optimisés pour les agents de codage.",
  ...
  "provider.connect.blackbox.visit.prefix": "Visitez ",
  "provider.connect.blackbox.visit.link": "blackbox.ai",
  "provider.connect.blackbox.visit.suffix": " pour récupérer votre clé API.",
  "provider.connect.oauth.code.visit.prefix": "Visitez ",
  "provider.connect.oauth.code.visit.link": "ce lien",
  "provider.connect.oauth.code.visit.suffix":
    " pour récupérer votre code d'autorisation afin de connecter votre compte et utiliser les modèles {{provider}} dans Blackbox.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " et entrez le code ci-dessous pour connecter votre compte et utiliser les modèles {{provider}} dans Blackbox.",
  ...
  "dialog.plugins.empty": "Plugins configurés dans blackbox.json",
  ...
  "dialog.server.description": "Changez le serveur Blackbox auquel cette application se connecte.",
  ...
  "toast.update.description":
    "Une nouvelle version d'Blackbox ({{version}}) est maintenant disponible pour installation.",
  ...
  "error.page.report.prefix": "Veuillez signaler cette erreur à l'équipe Blackbox",
  ...
  "error.chain.checkConfig": "Vérifiez votre configuration (blackbox.json) pour les noms de fournisseur/modèle",
  "error.chain.mcpFailed":
    "Le serveur MCP \"{{name}}\" a échoué. Notez qu'Blackbox ne supporte pas encore l'authentification MCP.",
  ...
  "sidebar.gettingStarted.line1":
    "Blackbox inclut des modèles gratuits pour que vous puissiez commencer immédiatement.",
  ...
  "settings.desktop.wsl.description": "Exécuter le serveur Blackbox dans WSL sur Windows.",
  ...
  "settings.general.row.language.description": "Changer la langue d'affichage pour Blackbox",
  "settings.general.row.appearance.title": "Apparence",
  "settings.general.row.appearance.description": "Personnaliser l'apparence d'Blackbox sur votre appareil",
  "settings.general.row.theme.title": "Thème",
  "settings.general.row.theme.description": "Personnaliser le thème d'Blackbox.",
  ...
  "settings.updates.row.startup.description": "Vérifier automatiquement les mises à jour au lancement d'Blackbox",
  ...
  "settings.updates.toast.latest.description": "Vous utilisez la dernière version d'Blackbox.",
