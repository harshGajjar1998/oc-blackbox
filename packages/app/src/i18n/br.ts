export const dict = {
  ...
  "dialog.provider.blackbox.note": "Modelos selecionados incluindo Claude, GPT, Gemini e mais",
  ...
  "dialog.model.unpaid.freeModels.title": "Modelos gratuitos fornecidos pelo Blackbox",
  ...
  "provider.connect.apiKey.description":
    "Digite sua chave de API do {{provider}} para conectar sua conta e usar modelos do {{provider}} no Blackbox.",
  ...
  "provider.connect.blackbox.line1":
    "Blackbox oferece acesso a um conjunto selecionado de modelos confiáveis otimizados para agentes de código.",
  "provider.connect.blackbox.line2":
    "Com uma única chave de API você terá acesso a modelos como Claude, GPT, Gemini, GLM e mais.",
  "provider.connect.blackbox.visit.prefix": "Visite ",
  "provider.connect.blackbox.visit.link": "blackbox.ai",
  "provider.connect.blackbox.visit.suffix": " para obter sua chave de API.",
  "provider.connect.oauth.code.visit.prefix": "Visite ",
  "provider.connect.oauth.code.visit.link": "este link",
  "provider.connect.oauth.code.visit.suffix":
    " para obter seu código de autorização e conectar sua conta para usar modelos do {{provider}} no Blackbox.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e digite o código abaixo para conectar sua conta e usar modelos do {{provider}} no Blackbox.",
  ...
  "dialog.plugins.empty": "Plugins configurados em blackbox.json",
  ...
  "dialog.server.description": "Trocar para qual servidor Blackbox este aplicativo se conecta.",
  ...
  "toast.update.description": "Uma nova versão do Blackbox ({{version}}) está disponível para instalação.",
  ...
  "error.page.report.prefix": "Por favor, reporte este erro para a equipe do Blackbox",
  ...
  "error.chain.checkConfig": "Verifique os nomes de provedor/modelo na sua configuração (blackbox.json)",
  "error.chain.mcpFailed": 'Servidor MCP "{{name}}" falhou. Nota: Blackbox ainda não suporta autenticação MCP.',
  ...
  "sidebar.gettingStarted.line1": "Blackbox inclui modelos gratuitos para você começar imediatamente.",
  ...
  "settings.desktop.wsl.description": "Executar o servidor Blackbox dentro do WSL no Windows.",
  ...
  "settings.general.row.language.description": "Alterar o idioma de exibição do Blackbox",
  "settings.general.row.appearance.title": "Aparência",
  "settings.general.row.appearance.description": "Personalize como o Blackbox aparece no seu dispositivo",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personalize como o Blackbox é tematizado.",
  ...
  "settings.updates.row.startup.description": "Verificar atualizações automaticamente quando o Blackbox iniciar",
  ...
  "settings.updates.toast.latest.description": "Você está usando a versão mais recente do Blackbox.",
