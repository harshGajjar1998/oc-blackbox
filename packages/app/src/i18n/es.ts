export const dict = {
  ...
  "dialog.provider.blackbox.note": "Modelos seleccionados incluyendo Claude, GPT, Gemini y más",
  ...
  "dialog.model.unpaid.freeModels.title": "Modelos gratuitos proporcionados por Blackbox",
  ...
  "provider.connect.apiKey.description":
    "Introduce tu clave API de {{provider}} para conectar tu cuenta y usar modelos de {{provider}} en Blackbox.",
  ...
  "provider.connect.blackbox.line1":
    "Blackbox te da acceso a un conjunto curado de modelos fiables optimizados para agentes de programación.",
  "provider.connect.blackbox.line2":
    "Con una sola clave API obtendrás acceso a modelos como Claude, GPT, Gemini, GLM y más.",
  "provider.connect.blackbox.visit.prefix": "Visita ",
  "provider.connect.blackbox.visit.link": "blackbox.ai",
  "provider.connect.blackbox.visit.suffix": " para obtener tu clave API.",
  "provider.connect.oauth.code.visit.prefix": "Visita ",
  "provider.connect.oauth.code.visit.link": "este enlace",
  "provider.connect.oauth.code.visit.suffix":
    " para obtener tu código de autorización para conectar tu cuenta y usar modelos de {{provider}} en Blackbox.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e introduce el código a continuación para conectar tu cuenta y usar modelos de {{provider}} en Blackbox.",
  ...
  "dialog.plugins.empty": "Plugins configurados en blackbox.json",
  ...
  "dialog.server.description": "Cambiar a qué servidor de Blackbox se conecta esta app.",
  ...
  "toast.update.description": "Una nueva versión de Blackbox ({{version}}) está disponible para instalar.",
  ...
  "error.page.report.prefix": "Por favor reporta este error al equipo de Blackbox",
  ...
  "error.chain.checkConfig": "Comprueba los nombres de proveedor/modelo en tu configuración (blackbox.json)",
  "error.chain.mcpFailed": 'El servidor MCP "{{name}}" falló. Nota, Blackbox no soporta autenticación MCP todavía.',
  ...
  "sidebar.gettingStarted.line1": "Blackbox incluye modelos gratuitos para que puedas empezar inmediatamente.",
  ...
  "settings.desktop.wsl.description": "Ejecutar el servidor Blackbox dentro de WSL en Windows.",
  ...
  "settings.general.row.language.description": "Cambiar el idioma de visualización para Blackbox",
  "settings.general.row.appearance.title": "Apariencia",
  "settings.general.row.appearance.description": "Personaliza cómo se ve Blackbox en tu dispositivo",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personaliza el tema de Blackbox.",
  ...
  "settings.updates.row.startup.description": "Buscar actualizaciones automáticamente cuando se inicia Blackbox",
  ...
  "settings.updates.toast.latest.description": "Estás usando la última versión de Blackbox.",
