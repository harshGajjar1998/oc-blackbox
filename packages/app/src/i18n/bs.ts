export const dict = {
  ...
  "dialog.provider.blackbox.note": "Kurirani modeli ukljucujuci Claude, GPT, Gemini i druge",
  ...
  "dialog.model.unpaid.freeModels.title": "Besplatni modeli koje obezbjeđuje Blackbox AI",
  ...
  "provider.connect.apiKey.description":
    "Unesi svoj {{provider}} API ključ da povežeš račun i koristiš {{provider}} modele u Blackbox AI-u.",
  ...
  "provider.connect.opencodeZen.line1":
    "Blackbox AI Zen ti daje pristup kuriranom skupu pouzdanih, optimizovanih modela za coding agente.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " da preuzmeš autorizacijski kod i povežeš račun te koristiš {{provider}} modele u Blackbox AI-u.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i unesi kod ispod da povežeš račun i koristiš {{provider}} modele u Blackbox AI-u.",
  ...
  "dialog.server.description": "Promijeni na koji se Blackbox AI server ova aplikacija povezuje.",
  ...
  "toast.update.description": "Nova verzija Blackbox AI-a ({{version}}) je dostupna za instalaciju.",
  ...
  "error.page.report.prefix": "Molimo prijavi ovu grešku Blackbox AI timu",
  ...
  "error.chain.mcpFailed": 'MCP server "{{name}}" nije uspio. Napomena: Blackbox AI još ne podržava MCP autentifikaciju.',
  ...
  "sidebar.gettingStarted.line1": "Blackbox AI uključuje besplatne modele, tako da možeš odmah početi.",
  ...
  "settings.desktop.wsl.description": "Pokreni Blackbox AI server unutar WSL-a na Windowsu.",
  ...
  "settings.general.row.language.description": "Promijeni jezik prikaza u Blackbox AI-u",
  "settings.general.row.appearance.title": "Izgled",
  "settings.general.row.appearance.description": "Prilagodi kako Blackbox AI izgleda na tvom uređaju",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Prilagodi temu Blackbox AI-a.",
  ...
  "settings.updates.row.startup.description": "Automatski provjerava ažuriranja kada se Blackbox AI pokrene",
  ...
  "settings.updates.toast.latest.description": "Koristiš najnoviju verziju Blackbox AI-a.",
