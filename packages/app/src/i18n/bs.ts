export const dict = {
  ...
  "dialog.provider.blackbox.note": "Kurirani modeli uključujući Claude, GPT, Gemini i druge",
  ...
  "dialog.model.unpaid.freeModels.title": "Besplatni modeli koje obezbjeđuje Blackbox",
  ...
  "provider.connect.apiKey.description":
    "Unesi svoj {{provider}} API ključ da povežeš račun i koristiš {{provider}} modele u Blackbox-u.",
  ...
  "provider.connect.blackbox.line1":
    "Blackbox ti daje pristup kuriranom skupu pouzdanih, optimizovanih modela za coding agente.",
  "provider.connect.blackbox.line2":
    "Sa jednim API ključem dobijaš pristup modelima kao što su Claude, GPT, Gemini, GLM i drugi.",
  "provider.connect.blackbox.visit.prefix": "Posjeti ",
  "provider.connect.blackbox.visit.link": "blackbox.ai",
  "provider.connect.blackbox.visit.suffix": " da preuzmeš svoj API ključ.",
  "provider.connect.oauth.code.visit.prefix": "Posjeti ",
  "provider.connect.oauth.code.visit.link": "ovaj link",
  "provider.connect.oauth.code.visit.suffix":
    " da preuzmeš autorizacijski kod i povežeš račun te koristiš {{provider}} modele u Blackbox-u.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i unesi kod ispod da povežeš račun i koristiš {{provider}} modele u Blackbox-u.",
  ...
  "dialog.plugins.empty": "Plugini su konfigurisani u blackbox.json",
  ...
  "dialog.server.description": "Promijeni na koji se Blackbox server ova aplikacija povezuje.",
  ...
  "toast.update.description": "Nova verzija Blackbox-a ({{version}}) je dostupna za instalaciju.",
  ...
  "error.page.report.prefix": "Molimo prijavi ovu grešku Blackbox timu",
  ...
  "error.chain.checkConfig": "Provjeri konfiguraciju (blackbox.json) provider/model names",
  "error.chain.mcpFailed": 'MCP server "{{name}}" nije uspio. Napomena: Blackbox još ne podržava MCP autentifikaciju.',
  ...
  "sidebar.gettingStarted.line1": "Blackbox uključuje besplatne modele, tako da možeš odmah početi.",
  ...
  "settings.desktop.wsl.description": "Pokreni Blackbox server unutar WSL-a na Windowsu.",
  ...
  "settings.general.row.language.description": "Promijeni jezik prikaza u Blackbox-u",
  "settings.general.row.appearance.title": "Izgled",
  "settings.general.row.appearance.description": "Prilagodi kako Blackbox izgleda na tvom uređaju",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Prilagodi temu Blackbox-a.",
  ...
  "settings.updates.row.startup.description": "Automatski provjerava ažuriranja kada se Blackbox pokrene",
  ...
  "settings.updates.toast.latest.description": "Koristiš najnoviju verziju Blackbox-a.",
