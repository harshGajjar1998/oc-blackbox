export const dict = {
  ...
  "provider.connect.apiKey.description":
    "Enter your {{provider}} API key to connect your account and use {{provider}} models in Blackbox AI.",
  ...
  "provider.connect.opencodeZen.visit.link": "blackbox.ai",
  "provider.connect.opencodeZen.visit.suffix": " to learn more.",
  "provider.connect.oauth.code.visit.prefix": "Visit ",
  "provider.connect.oauth.code.visit.link": "this link",
  "provider.connect.oauth.code.visit.suffix":
    " to collect your authorization code to connect your account and use {{provider}} models in Blackbox AI.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " and enter the code below to connect your account and use {{provider}} models in Blackbox AI.",
  ...
  "dialog.server.description": "Switch which Blackbox AI server this app connects to.",
  ...
  "toast.update.description": "A new version of Blackbox AI ({{version}}) is now available to install.",
  ...
  "error.page.report.prefix": "Please report this error to the Blackbox AI team",
  ...
  "error.chain.mcpFailed": 'MCP server "{{name}}" failed. Note, Blackbox AI does not support MCP authentication yet.',
  ...
  "sidebar.gettingStarted.line1": "Blackbox AI includes free models so you can start immediately.",
  ...
  "settings.desktop.wsl.description": "Run the Blackbox AI server inside WSL on Windows.",
  ...
  "settings.general.row.language.description": "Change the display language for Blackbox AI",
  "settings.general.row.appearance.title": "Appearance",
  "settings.general.row.appearance.description": "Customise how Blackbox AI looks on your device",
  "settings.general.row.theme.title": "Theme",
  "settings.general.row.theme.description": "Customise how Blackbox AI is themed.",
  ...
  "settings.updates.row.startup.description": "Automatically check for updates when Blackbox AI launches",
  ...
  "settings.updates.toast.latest.description": "You're running the latest version of Blackbox AI.",
