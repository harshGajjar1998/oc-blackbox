export const dict = {
  ...
  "dialog.provider.blackbox.note": "Curated models including Claude, GPT, Gemini and more",
  ...
  "dialog.model.unpaid.freeModels.title": "Free models provided by Blackbox AI",
  ...
  "provider.connect.apiKey.description":
    "Enter your {{provider}} API key to connect your account and use {{provider}} models in Blackbox.",
  "provider.connect.apiKey.label": "{{provider}} API key",
  "provider.connect.apiKey.placeholder": "API key",
  "provider.connect.apiKey.required": "API key is required",
  "provider.connect.blackbox.line1":
    "Blackbox AI gives you access to a curated set of reliable optimized models for coding agents.",
  "provider.connect.blackbox.line2":
    "With a single API key you'll get access to models such as Claude, GPT, Gemini, GLM and more.",
  "provider.connect.blackbox.visit.prefix": "Visit ",
  "provider.connect.blackbox.visit.link": "blackbox.ai",
  "provider.connect.blackbox.visit.suffix": " to collect your API key.",
  "provider.connect.opencodeZen.line1": "OpenCode Zen gives you guided setup for provider access.",
  "provider.connect.opencodeZen.line2": "Follow the OpenCode Zen instructions to continue connecting your provider.",
  "provider.connect.opencodeZen.visit.prefix": "Visit ",
  "provider.connect.opencodeZen.visit.link": "OpenCode Zen",
  "provider.connect.opencodeZen.visit.suffix": " for setup details.",
  "provider.connect.oauth.code.visit.prefix": "Visit ",
  "provider.connect.oauth.code.visit.link": "this link",
  "provider.connect.oauth.code.visit.suffix":
    " to collect your authorization code to connect your account and use {{provider}} models in Blackbox.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " and enter the code below to connect your account and use {{provider}} models in Blackbox.",
  ...
  "dialog.server.description": "Switch which Blackbox server this app connects to.",
  ...
  "toast.update.description": "A new version of Blackbox ({{version}}) is now available to install.",
  ...
  "error.page.report.prefix": "Please report this error to the Blackbox team",
  ...
  "error.chain.checkConfig": "Check your config (blackbox.json) provider/model names",
  "error.chain.mcpFailed": 'MCP server "{{name}}" failed. Note, Blackbox does not support MCP authentication yet.',
  ...
  "sidebar.gettingStarted.line1": "Blackbox includes free models so you can start immediately.",
  "sidebar.gettingStarted.line2": "Connect any provider to use models, inc. Claude, GPT, Gemini etc.",
  "sidebar.project.recentSessions": "Recent sessions",
  "sidebar.project.viewAllSessions": "View all sessions",
  "sidebar.project.clearNotifications": "Clear notifications",

  "app.name.desktop": "Blackbox Desktop",
  ...
  "settings.desktop.wsl.description": "Run the Blackbox server inside WSL on Windows.",
  ...
  "settings.general.row.language.description": "Change the display language for Blackbox",
  "settings.general.row.appearance.title": "Appearance",
  "settings.general.row.appearance.description": "Customise how Blackbox looks on your device",
  "settings.general.row.theme.title": "Theme",
  "settings.general.row.theme.description": "Customise how Blackbox is themed.",
  ...
  "settings.updates.row.startup.description": "Automatically check for updates when Blackbox launches",
  ...
  "settings.updates.toast.latest.description": "You're running the latest version of Blackbox.",
