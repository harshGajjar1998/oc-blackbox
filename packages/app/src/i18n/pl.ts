export const dict = {
  ...
  "dialog.provider.blackbox.note": "Wyselekcjonowane modele, w tym Claude, GPT, Gemini i inne",
  ...
  "dialog.model.unpaid.freeModels.title": "Darmowe modele dostarczane przez Blackbox",
  ...
  "provider.connect.apiKey.description":
    "Wprowadź swój klucz API {{provider}}, aby połączyć konto i używać modeli {{provider}} w Blackbox.",
  ...
  "provider.connect.blackbox.line1":
    "Blackbox daje dostęp do wybranego zestawu niezawodnych, zoptymalizowanych modeli dla agentów kodujących.",
  "provider.connect.blackbox.line2":
    "Z jednym kluczem API uzyskasz dostęp do modeli takich jak Claude, GPT, Gemini, GLM i więcej.",
  "provider.connect.blackbox.visit.prefix": "Odwiedź ",
  "provider.connect.blackbox.visit.link": "blackbox.ai",
  "provider.connect.blackbox.visit.suffix": ", aby odebrać swój klucz API.",
  "provider.connect.oauth.code.visit.prefix": "Odwiedź ",
  "provider.connect.oauth.code.visit.link": "ten link",
  "provider.connect.oauth.code.visit.suffix":
    ", aby odebrać kod autoryzacyjny, połączyć konto i używać modeli {{provider}} w Blackbox.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i wprowadź poniższy kod, aby połączyć konto i używać modeli {{provider}} w Blackbox.",
  ...
  "dialog.plugins.empty": "Wtyczki skonfigurowane w blackbox.json",
  ...
  "dialog.server.description": "Przełącz serwer Blackbox, z którym łączy się ta aplikacja.",
  ...
  "toast.update.description": "Nowa wersja Blackbox ({{version}}) jest teraz dostępna do instalacji.",
  ...
  "error.page.report.prefix": "Proszę zgłosić ten błąd do zespołu Blackbox",
  ...
  "error.chain.checkConfig": "Sprawdź swoją konfigurację (blackbox.json) nazwy dostawców/modeli",
  ...
  "sidebar.gettingStarted.line1": "Blackbox zawiera darmowe modele, więc możesz zacząć od razu.",
  ...
  "settings.general.row.language.description": "Zmień język wyświetlania dla Blackbox",
  "settings.general.row.appearance.title": "Wygląd",
  "settings.general.row.appearance.description": "Dostosuj wygląd Blackbox na swoim urządzeniu",
  "settings.general.row.theme.title": "Motyw",
  "settings.general.row.theme.description": "Dostosuj motyw Blackbox.",
  ...
  "settings.updates.row.startup.description": "Automatycznie sprawdzaj aktualizacje podczas uruchamiania Blackbox",
  ...
  "settings.updates.toast.latest.description": "Korzystasz z najnowszej wersji Blackbox.",
