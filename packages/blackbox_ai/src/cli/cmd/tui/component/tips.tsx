...
const TIPS = [
  ...
  "Run {highlight}/share{/highlight} to create a public link to your conversation at blackbox.ai",
  ...
  "Blackbox AI auto-handles OAuth for remote MCP servers requiring auth",
  ...
  "Blackbox AI auto-formats files using prettier, gofmt, ruff, and more",
  'Set {highlight}"formatter": false{/highlight} in config to disable all auto-formatting',
  "Define custom formatter commands with file extensions in config",
  "Blackbox AI uses LSP servers for intelligent code analysis",
  ...
  "Create a plugin to prevent Blackbox AI from reading sensitive files",
  "Use {highlight}opencode run{/highlight} for non-interactive scripting",
  "Use {highlight}opencode --continue{/highlight} to resume the last session",
  "Use {highlight}opencode run -f file.ts{/highlight} to attach files via CLI",
  "Use {highlight}--format json{/highlight} for machine-readable output in scripts",
  "Run {highlight}opencode serve{/highlight} for headless API access to Blackbox AI",
  ...
  "Use {highlight}/connect{/highlight} with Blackbox AI Zen for curated, tested models",
