...
export namespace Config {
  ...
  export const state = Instance.state(async () => {
    ...
    // Config loading order (low -> high precedence): https://blackbox.ai/docs/config#precedence-order
  ...
  export const Info = z
    .object({
      ...
      command: z
        ...
        .optional()
        .describe("Command configuration, see https://blackbox.ai/docs/commands"),
      ...
      agent: z
        ...
        .catchall(Agent)
        .optional()
        .describe("Agent configuration, see https://blackbox.ai/docs/agents"),
      provider: z
