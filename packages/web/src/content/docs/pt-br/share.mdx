---
title: Compartilhar
description: Compartilhe suas conversas do blackbox ai.
---

O recurso de compartilhamento do blackbox ai permite que você crie links públicos para suas conversas do blackbox ai, para que você possa colaborar com colegas de equipe ou obter ajuda de outros.
...
Quando você compartilha uma conversa, o blackbox ai:
...
O blackbox ai suporta três modos de compartilhamento que controlam como as conversas são compartilhadas:

---

### Manual (padrão)

Por padrão, o blackbox ai usa o modo de compartilhamento manual. As sessões não são compartilhadas automaticamente, mas você pode compartilhá-las manualmente usando o comando `/share`:
...
Para impor isso em sua equipe para um determinado projeto, adicione-o ao `blackbox ai.json` em seu projeto e faça o check-in no Git.
...
[Saiba mais](/docs/enterprise) sobre como usar o blackbox ai em sua organização.
