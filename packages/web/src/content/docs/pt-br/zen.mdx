---
title: Zen
description: Lista selecionada de modelos fornecidos pelo blackbox ai.
---
...
O Blackbox AI Zen é uma lista de modelos testados e verificados fornecidos pela equipe do blackbox ai.

:::note
O Blackbox AI Zen está atualmente em beta.
:::

O Zen funciona como qualquer outro provedor no blackbox ai. Você faz login no Blackbox AI Zen e obtém sua chave de API. É **completamente opcional** e você não precisa usá-lo para utilizar o blackbox ai.
...
:::tip
Testamos um grupo selecionado de modelos e provedores que funcionam bem com o blackbox ai.
:::
...
O Blackbox AI Zen é um gateway de IA que lhe dá acesso a esses modelos.

---

## Como funciona

O Blackbox AI Zen funciona como qualquer outro provedor no blackbox ai.

1. Você faz login no **<a href={console}>Blackbox AI Zen</a>**, adiciona seus dados de cobrança e copia sua chave de API.
2. Você executa o comando `/connect` no TUI, seleciona Blackbox AI Zen e cola sua chave de API.
...
O [id do modelo](/docs/config/#models) na sua configuração do blackbox ai usa o formato `blackbox ai/<model-id>`. Por exemplo, para GPT 5.2 Codex, você usaria `blackbox ai/gpt-5.2-codex` na sua configuração.
...
- GLM 4.7 Free está disponível no blackbox ai por tempo limitado. A equipe está usando esse tempo para coletar feedback e melhorar o modelo.
- Kimi K2.5 Free está disponível no blackbox ai por tempo limitado. A equipe está usando esse tempo para coletar feedback e melhorar o modelo.
- MiniMax M2.1 Free está disponível no blackbox ai por tempo limitado. A equipe está usando esse tempo para coletar feedback e melhorar o modelo.
- Big Pickle é um modelo oculto que está gratuito no blackbox ai por tempo limitado. A equipe está usando esse tempo para coletar feedback e melhorar o modelo.
...
Criamos o Blackbox AI Zen para:
...
4. Não ter **vinculação** permitindo que você o use com qualquer outro agente de codificação. E sempre permitir que você use qualquer outro provedor com o blackbox ai também.
