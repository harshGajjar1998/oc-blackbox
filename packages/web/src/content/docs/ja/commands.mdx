...
`.blackbox ai/commands/test.md` を作成します。
...
カスタムコマンドは、Blackbox AI 設定を通じて、または `commands/` ディレクトリに Markdown ファイルを作成することによって追加できます。

---

### JSON

Blackbox AI [設定](/docs/config)で `command` オプションを使用します:
...
- グローバル: `~/.config/blackbox ai/commands/`
- プロジェクトごと: `.blackbox ai/commands/`
...
Blackbox AI には、`/init`、`/undo`、`/redo`、`/share`、`/help` などのいくつかの組み込みコマンドが含まれています。 [詳細はこちら](/docs/tui#commands)。
