---
title: TUI
description: Blackbox AI ターミナルユーザーインターフェイスの使用。
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

Blackbox AI は、LLM を使用してプロジェクトを作業するための対話型ターミナルインターフェイスまたは TUI を提供します。

Blackbox AI を実行すると、現在のディレクトリの TUI が開始されます。
...
Blackbox AI TUI を使用する場合、「`/`」に続いてコマンド名を入力すると、アクションをすばやく実行できます。例えば：
...
Blackbox AI にプロバイダーを追加します。利用可能なプロバイダーから選択し、その API キーを追加できます。
...
Blackbox AI を終了します。 _エイリアス_: `/quit`、`/q`
...
Blackbox AI 設定ファイルを通じて TUI の動作をカスタマイズできます。
