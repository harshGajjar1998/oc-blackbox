---
title: Zen
description: Wyselekcjonowana lista modeli dostarczonych przez blackbox ai.
---
...
Blackbox AI Zen to lista przetestowanych i zweryfikowanych modeli udostępniona przez zespół blackbox ai.

:::note
Blackbox AI Zen is currently in beta.
:::

Zen działa jak każdy inny dostawca blackbox ai. Logujesz się do Blackbox AI Zen i dostajesz
...
:::tip
Przetestowaliśmy wybraną grupę modeli i dostawców, którzy dobrze współpracują z blackbox ai.
:::
...
Blackbox AI Zen to brama AI, która zapewnia dostęp do tych modeli.

---

## Jak to działa

Blackbox AI Zen działa jak każdy inny dostawca blackbox ai.

1. Logujesz się do **<a href={console}>Blackbox AI Zen</a>**, dodajesz swoje rozliczenia
   szczegóły i skopiuj klucz API.
2. Uruchamiasz polecenie `/connect` w TUI, wybierasz Blackbox AI Zen i wklejasz klucz API.
...
[Identyfikator modelu](/docs/config/#models) w konfiguracji blackbox ai
używa formatu `blackbox ai/<model-id>`. Na przykład w przypadku Kodeksu GPT 5.2 zrobiłbyś to
użyj `blackbox ai/gpt-5.2-codex` w swojej konfiguracji.
...
- GLM 4.7 Free jest dostępny na platformie blackbox ai przez ograniczony czas. Zespół wykorzystuje ten czas na zbieranie opinii i ulepszanie modelu.
- Kimi K2.5 Free jest dostępny na blackbox ai przez ograniczony czas. Zespół wykorzystuje ten czas na zbieranie opinii i ulepszanie modelu.
- MiniMax M2.1 Free jest dostępny na platformie blackbox ai przez ograniczony czas. Zespół wykorzystuje ten czas na zbieranie opinii i ulepszanie modelu.
- Big Pickle to ukryty model, który jest bezpłatny w blackbox ai przez ograniczony czas. Zespół wykorzystuje ten czas na zbieranie opinii i ulepszanie modelu.
...
Stworzyliśmy Blackbox AI Zen, aby:
...
4. Nie **nie blokuj**, umożliwiając używanie go z dowolnym innym agentem kodującym. I zawsze pozwalaj na korzystanie z blackbox ai dowolnego innego dostawcy.
