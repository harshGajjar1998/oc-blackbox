---
title: TUI
description: Korzystanie z interfejsu użytkownika terminala blackbox ai.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

blackbox ai zapewnia interaktywny interfejs terminala lub TUI do pracy nad projektami za pomocą LLM.

Uruchomienie blackbox ai uruchamia TUI dla bieżącego katalogu.
...
Korzystając z TUI blackbox ai, możesz wpisać `/`, po którym następuje nazwa polecenia, aby szybko wykonać działania. Na przykład:
...
Dodaj dostawcę do blackbox ai. Umożliwia wybór dostępnych dostawców i dodanie ich kluczy API.
...
Zamknij blackbox ai. _Aliasy_: `/quit`, `/q`
...
Możesz dostosować zachowanie TUI za pomocą pliku konfiguracyjnego blackbox ai.
