---
title: Udostępnianie
description: Udostępnij swoje rozmowy dotyczące blackbox ai.
---

Funkcja udostępniania blackbox ai umożliwia tworzenie publicznych linków do konwersacji blackbox ai, dzięki czemu możesz współpracować z członkami zespołu lub uzyskać pomoc od innych.
...
Kiedy udostępniasz rozmowę, blackbox ai:
...
blackbox ai obsługuje trzy tryby udostępniania, które kontrolują sposób udostępniania rozmów:

---

### Ręczne (domyślne)

Domyślnie blackbox ai korzysta z ręcznego trybu udostępniania. Sesje nie są udostępniane automatycznie, ale możesz je udostępnić ręcznie za pomocą polecenia `/share`:
...
Aby wymusić to w całym zespole dla danego projektu, dodaj go do `blackbox ai.json` w swoim projekcie i sprawdź w Git.
...
[Dowiedz się więcej](/docs/enterprise) o używaniu blackbox ai w Twojej organizacji.
