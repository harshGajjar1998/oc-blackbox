...
blackbox ai zawiera listę skrótów klawiszowych, które można zastosować poprzez blackbox ai.
...
blackbox ai używa klucza `leader` dla głównych skrótów klawiszowych. Rozwiązanie problemu konfliktów w terminalu.
...
Pole sprawdzania aplikacji komputerowej blackbox ai obsługuje popularne skróty w stylu Readline/Emacs do edycji tekstu. Są one dostępne i obecnie nie można ich skonfigurować za pomocą `blackbox ai.json`.
