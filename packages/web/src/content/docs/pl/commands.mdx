...
Utwórz `.blackbox ai/commands/test.md`:
...
Możesz zdefiniować polecenia w `blackbox ai.json` lub w plikach w katalogu `commands/`.

---

### JSON

Użyj opcji `command` w swojej konfiguracji blackbox ai:
...
- Globalnie: `~/.config/blackbox ai/commands/`
- Na projekt: `.blackbox ai/commands/`
...
blackbox ai zawiera kilka wbudowanych poleceń, takich jak `/init`, `/undo`, `/redo`, `/share`, `/help`; [dowiedz się więcej](/docs/tui#commands).
