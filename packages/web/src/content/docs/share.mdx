---
title: Share
description: Share your Blackbox AI conversations.
---

Blackbox AI's share feature allows you to create public links to your Blackbox AI conversations, so you can collaborate with teammates or get help from others.
...
When you share a conversation, Blackbox AI:
...
Blackbox AI supports three sharing modes that control how conversations are shared:

---

### Manual (default)

By default, Blackbox AI uses manual sharing mode. Sessions are not shared automatically, but you can manually share them using the `/share` command:
...
To enforce this across your team for a given project, add it to the `blackbox ai.json` in your project and check into Git.
...
[Learn more](/docs/enterprise) about using blackbox ai in your organization.
