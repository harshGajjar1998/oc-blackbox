---
title: Condivisione
description: Condividi le tue conversazioni Blackbox AI.
---

La funzione di condivisione di Blackbox AI ti permette di creare link pubblici alle tue conversazioni, cosi puoi collaborare con i colleghi o chiedere aiuto ad altre persone.
...
Quando condividi una conversazione, Blackbox AI:
...
Blackbox AI supporta tre modalita di condivisione che controllano come vengono condivise le conversazioni:

---

### Manuale (predefinito)

Per impostazione predefinita, Blackbox AI usa la condivisione manuale. Le sessioni non vengono condivise automaticamente, ma puoi condividerle manualmente con il comando `/share`:
...
Per applicarlo al tuo team in un progetto specifico, aggiungilo a `blackbox ai.json` nel progetto e versionalo su Git.
...
[Scopri di piu](/docs/enterprise) su come usare blackbox ai nella tua organizzazione.
