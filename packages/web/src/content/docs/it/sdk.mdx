---
title: SDK
description: Client JS type-safe per il server blackbox ai.
---

import config from "../../../../config.mjs"
export const typesUrl = `${config.github}/blob/dev/packages/sdk/js/src/gen/types.gen.ts`

L'SDK JS/TS di blackbox ai fornisce un client type-safe per interagire con il server.
Usalo per creare integrazioni e controllare blackbox ai in modo programmatico.
...
Crea un'istanza di blackbox ai:
...
Puoi passare un oggetto di configurazione per personalizzare il comportamento. L'istanza legge comunque `blackbox ai.json`, ma puoi sovrascrivere o aggiungere configurazione inline:
...
Se hai gia un'istanza di blackbox ai in esecuzione, puoi creare un client per collegarti:
