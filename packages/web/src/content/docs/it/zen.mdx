---
title: Zen
description: Lista curata di modelli fornita da Blackbox AI.
---
...
Blackbox AI Zen e una lista di modelli testati e verificati dal team di Blackbox AI.

:::note
Blackbox AI Zen e attualmente in beta.
:::

Zen funziona come qualunque altro provider in Blackbox AI. Accedi a Blackbox AI Zen e ottieni la tua chiave API. E **completamente opzionale**: non devi usarlo per usare Blackbox AI.
...
:::tip
Abbiamo testato un gruppo selezionato di modelli e provider che funzionano bene con Blackbox AI.
:::
...
Blackbox AI Zen e un gateway AI che ti da accesso a questi modelli.

---

## Come funziona

Blackbox AI Zen funziona come qualunque altro provider in Blackbox AI.

1. Accedi a **<a href={console}>Blackbox AI Zen</a>**, aggiungi i dettagli di fatturazione e copia la chiave API.
2. Esegui il comando `/connect` nella TUI, seleziona Blackbox AI Zen e incolla la chiave API.
...
Il [model id](/docs/config/#models) nella config di Blackbox AI usa il formato `blackbox ai/<model-id>`. Per esempio, per GPT 5.2 Codex useresti `blackbox ai/gpt-5.2-codex` nella config.
...
- GLM 4.7 Free e disponibile su Blackbox AI per un periodo limitato. Il team usa questo tempo per raccogliere feedback e migliorare il modello.
- Kimi K2.5 Free e disponibile su Blackbox AI per un periodo limitato. Il team usa questo tempo per raccogliere feedback e migliorare il modello.
- MiniMax M2.1 Free e disponibile su Blackbox AI per un periodo limitato. Il team usa questo tempo per raccogliere feedback e migliorare il modello.
- Big Pickle e un modello stealth gratuito su Blackbox AI per un periodo limitato. Il team usa questo tempo per raccogliere feedback e migliorare il modello.
...
Abbiamo creato Blackbox AI Zen per:
...
4. Evitare **lock-in** permettendoti di usarlo con qualunque altro agente di coding e lasciandoti sempre usare anche altri provider con Blackbox AI.
