...
Crea `.blackbox ai/commands/test.md`:
...
Puoi aggiungere comandi personalizzati tramite la config di Blackbox AI o creando file markdown nella directory `commands/`.

---

### JSON

Usa l'opzione `command` nella [config](/docs/config) di Blackbox AI:
...
- Globale: `~/.config/blackbox ai/commands/`
- Per progetto: `.blackbox ai/commands/`
...
blackbox ai include diversi comandi integrati come `/init`, `/undo`, `/redo`, `/share`, `/help`; [scopri di piu](/docs/tui#commands).
