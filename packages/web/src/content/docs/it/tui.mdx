---
title: TUI
description: Usa l'interfaccia utente da terminale (TUI) di Blackbox AI.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

Blackbox AI fornisce un'interfaccia interattiva da terminale (TUI) per lavorare sui tuoi progetti con un LLM.

Eseguire Blackbox AI avvia la TUI per la directory corrente.
...
Quando usi la TUI di Blackbox AI, puoi digitare `/` seguito dal nome di un comando per eseguire rapidamente azioni. Per esempio:
...
Aggiunge un provider a Blackbox AI. Ti permette di selezionare tra i provider disponibili e aggiungere le relative chiavi API.
...
Esce da Blackbox AI. _Alias_: `/quit`, `/q`
...
Puoi personalizzare il comportamento della TUI tramite il file di config di Blackbox AI.
