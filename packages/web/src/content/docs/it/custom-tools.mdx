...
description: Crea strumenti che l'LLM puo chiamare in blackbox ai.
---

Gli strumenti personalizzati sono funzioni che crei e che l'LLM puo chiamare durante le conversazioni. Funzionano insieme agli [strumenti integrati](/docs/tools) di blackbox ai come `read`, `write` e `bash`.
...
- In locale, mettendoli nella directory `.blackbox ai/tools/` del progetto.
- Oppure in globale, mettendoli in `~/.config/blackbox ai/tools/`.
