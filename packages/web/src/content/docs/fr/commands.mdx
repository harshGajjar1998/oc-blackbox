...
Créez `.blackbox ai/commands/test.md` :
...
Vous pouvez ajouter des commandes personnalisées via la configuration Blackbox AI ou en créant des fichiers markdown dans le répertoire `commands/`.

---

### JSON

Utilisez l'option `command` dans votre Blackbox AI [config](/docs/config) :
...
- Par projet : `.blackbox ai/commands/`
...
blackbox ai comprend plusieurs commandes intégrées comme `/init`, `/undo`, `/redo`, `/share`, `/help` ; [en savoir plus](/docs/tui#commands).
