...
يوجد نوعان من الوكلاء في Blackbox AI: وكلاء أساسيون ووكلاء فرعيون.
...
يأتي Blackbox AI مع وكيلين أساسيين مدمجين: **Build** و **Plan**. سنلقي نظرة عليهما أدناه.
...
يأتي Blackbox AI مع وكيلين فرعيين مدمجين: **General** و **Explore**. سنلقي نظرة على ذلك أدناه.

---

## المدمجة

يأتي Blackbox AI مع وكيلين أساسيين مدمجين ووكيلين فرعيين مدمجين.
...
هيّئ الوكلاء في ملف إعدادات `blackbox ai.json`:
...
- عام: `~/.config/blackbox ai/agents/`
- لكل مشروع: `.blackbox ai/agents/`
...
إذا لم يتم تحديد temperature، يستخدم Blackbox AI القيم الافتراضية الخاصة بالنموذج؛ عادة 0 لمعظم النماذج و 0.55 لنماذج Qwen.
...
هذا المسار نسبي لمكان وجود ملف الإعدادات. لذلك يعمل هذا لكل من إعدادات Blackbox AI العامة وإعدادات المشروع.
...
يستخدم معرّف النموذج في إعدادات Blackbox AI الصيغة `provider/model-id`. على سبيل المثال، إذا كنت تستخدم [Blackbox AI Zen](/docs/zen)، فستستخدم `blackbox ai/gpt-5.1-codex` لـ GPT 5.1 Codex.
...
:::tip
شغّل `blackbox ai models` لعرض قائمة بالنماذج المتاحة.
:::
...
:::tip
هل لديك وكيل تود مشاركته؟ [قدّم PR](https://github.com/anomalyco/blackbox ai).
:::
