---
title: خوادم LSP
description: يتكامل Blackbox AI مع خوادم LSP لديك.
---

يتكامل Blackbox AI مع بروتوكول خادم اللغة (LSP) لمساعدة LLM على التفاعل مع قاعدة الشيفرة لديك. ويستخدم التشخيصات لتزويد LLM بتغذية راجعة.

---

## المدمجة

يأتي Blackbox AI مع عدة خوادم LSP مدمجة للغات الشائعة:
...
:::note
يمكنك تعطيل تنزيلات خوادم LSP التلقائية عبر ضبط متغير البيئة `BLACKBOX_AI_DISABLE_LSP_DOWNLOAD` على `true`.
:::
...
عندما يفتح blackbox ai ملفا، فإنه:
...
يمكنك تخصيص خوادم LSP عبر قسم `lsp` في إعدادات blackbox ai.
