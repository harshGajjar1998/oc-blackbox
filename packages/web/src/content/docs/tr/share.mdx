---
title: Paylasim
description: blackbox ai konusmalarini genel baglantilarla paylasin.
---

blackbox ai'un paylasim ozelligi, konusmalariniz icin genel baglantilar olusturmanizi saglar. Boylece ekip arkadaslarinizla birlikte calisabilir veya diger kisilerden yardim alabilirsiniz.
...
Bir konusmayi paylastiginizda blackbox ai:
...
blackbox ai, konusmalarin nasil paylasilacagini kontrol eden uc farkli paylasim modu sunar:

---

### Manuel (varsayilan)

Varsayilan olarak blackbox ai manuel paylasim modunu kullanir. Oturumlar otomatik paylasilmaz, ancak `/share` komutuyla manuel olarak paylasabilirsiniz:
...
Bunu belirli bir projede tum ekip icin zorunlu kilmak icin proje icindeki `blackbox ai.json` dosyasina ekleyip Git'e commit edin.
...
Kurulusunuzda blackbox ai kullanimi icin [daha fazla bilgi alin](/docs/enterprise).
