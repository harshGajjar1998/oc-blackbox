...
`.blackbox ai/commands/test.md` oluştur:
...
blackbox ai işlemleri aracılığıyla veya `commands/` dizininde işaretleme dosyalarının oluşturulması özel komutlar ile yapılabilir.

---

### JSON

blackbox ai [config](/docs/config)'deki `command` seçeneğini kullanın:
...
- Küresel: `~/.config/blackbox ai/commands/`
- Proje başına: `.blackbox ai/commands/`
...
blackbox ai, `/init`, `/undo`, `/redo`, `/share`, `/help` gibi çeşitli yerleşik komutlar içerir; [learn more](/docs/tui#commands).
