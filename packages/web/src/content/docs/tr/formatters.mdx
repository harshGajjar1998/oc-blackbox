...
description: blackbox ai dile özgü biçimlendiriciler kullanır.
---

blackbox ai, dosyaları dile özgü formatlayıcılar kullanılarak yazıldıktan veya düzenlendikten sonra otomatik olarak formatlar. Bu, oluşturulan kodun projenizin kod stillerine uymasını sağlar.

---

## Yerleşik

blackbox ai, popüler diller ve çerçeveler için çeşitli yerleşik biçimlendiricilerle birlikte gelir. Aşağıda ihtiyaç duyduğu biçimlendiricilerin, desteklenen dosya uzantılarının ve komutların veya yapılandırma seçeneklerinin bir listesi bulunmaktadır.
...
Yani eğer projenizin `package.json` dosyasında `prettier` varsa, blackbox ai bunu otomatik olarak kullanacaktır.

---

## Nasıl çalışır?

blackbox ai bir dosyayı yazdığında veya düzenlediğinde:
...
Biçimlendiricileri blackbox ai yapılandırmanızdaki `formatter` bölümü aracılığıyla özelleştirebilirsiniz.
