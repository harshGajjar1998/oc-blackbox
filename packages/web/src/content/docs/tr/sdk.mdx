---
title: SDK
description: blackbox ai sunucusu için type-safe JS istemcisi.
---

import config from "../../../../config.mjs"
export const typesUrl = `${config.github}/blob/dev/packages/sdk/js/src/gen/types.gen.ts`

blackbox ai JS/TS SDK, sunucu ile etkileşmek için type-safe bir istemci sağlar.
blackbox ai'u programatik olarak kontrol etmek ve entegrasyonlar oluşturmak için kullanabilirsiniz.
...
Bir blackbox ai örneği oluşturun:
...
Davranışı özelleştirmek için bir yapılandırma nesnesi iletebilirsiniz. Örnek yine de `blackbox ai.json` dosyanızı alır, ancak yapılandırmayı satır içi olarak geçersiz kılabilir veya ekleyebilirsiniz:
...
Halihazırda çalışan bir blackbox ai örneğiniz varsa, ona bağlanmak için bir istemci örneği oluşturabilirsiniz:
