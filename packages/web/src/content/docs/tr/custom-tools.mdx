---
title: Özel Araçlar
description: LLM'un blackbox ai'da çağırabileceği araçları birleştirebilir.
---

Özel araçlar, LLM'un konuşmalar sırasında arayabileceği, oluşturduğunuz işlevlerdir. blackbox ai'un [built-in tools](/docs/tools) ile birlikte `read`, `write` ve `bash` gibi çalışırlar.
...
- Yerel olarak bunları projenizin `.blackbox ai/tools/` dizinine yerleştirerek.
- Veya küresel olarak bunları `~/.config/blackbox ai/tools/` içine yerleştirerek.
