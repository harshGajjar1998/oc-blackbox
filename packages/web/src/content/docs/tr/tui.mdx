---
title: TUI
description: blackbox ai terminal arayuzunu kullanin.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

blackbox ai, projelerinizde LLM ile calismak icin etkilesimli bir terminal arayuzu (TUI) sunar.

blackbox ai'u calistirdiginizda mevcut dizin icin TUI baslar.
...
blackbox ai TUI kullanirken `/` ve komut adini yazarak hizli eylemler calistirabilirsiniz. Ornek:
...
blackbox ai'a bir provider ekler. Mevcut provider'lari secip API anahtarlari eklemenizi saglar.
...
blackbox ai'dan cikar. _Takma adlar_: `/quit`, `/q`
...
TUI davranisini blackbox ai config dosyanizdan ozellestirebilirsiniz.
