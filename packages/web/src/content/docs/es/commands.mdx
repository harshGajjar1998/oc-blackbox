...
Crear `.blackbox ai/commands/test.md`:
...
Puede agregar comandos personalizados a través de la configuración Blackbox AI o creando archivos de Markdown en el directorio `commands/`.

---

### JSON

Utilice la opción `command` en su Blackbox AI [config](/docs/config):
...
- Por proyecto: `.blackbox ai/commands/`
...
blackbox ai incluye varios comandos integrados como `/init`, `/undo`, `/redo`, `/share`, `/help`; [más información](/docs/tui#commands).
