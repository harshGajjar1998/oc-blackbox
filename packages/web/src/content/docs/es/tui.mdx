---
title: TUI
description: Usando la interfaz de usuario del terminal Blackbox AI.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

Blackbox AI proporciona una interfaz de terminal interactiva o TUI para trabajar en sus proyectos con un LLM.

Al ejecutar Blackbox AI se inicia TUI para el directorio actual.
...
Cuando utilice Blackbox AI TUI, puede escribir `/` seguido de un nombre de comando para ejecutar acciones rápidamente. Por ejemplo:
...
Agregue un proveedor a Blackbox AI. Le permite seleccionar entre proveedores disponibles y agregar sus claves API.
...
Salga de Blackbox AI. _Alias_: `/quit`, `/q`
...
Puede personalizar el comportamiento de TUI a través de su archivo de configuración Blackbox AI.
