...
Las habilidades del agente permiten a Blackbox AI descubrir instrucciones reutilizables de su repositorio o directorio de inicio.
...
Blackbox AI busca estas ubicaciones:

- Configuración del proyecto: `.blackbox ai/skills/<name>/SKILL.md`
- Configuración global: `~/.config/blackbox ai/skills/<name>/SKILL.md`
...
Para las rutas locales del proyecto, Blackbox AI sube desde su directorio de trabajo actual hasta llegar al árbol de trabajo de git.
Carga cualquier `skills/*/SKILL.md` coincidente en `.blackbox ai/` y cualquier `.claude/skills/*/SKILL.md` o `.agents/skills/*/SKILL.md` coincidente a lo largo del camino.

Las definiciones globales también se cargan desde `~/.config/blackbox ai/skills/*/SKILL.md`, `~/.claude/skills/*/SKILL.md` y `~/.agents/skills/*/SKILL.md`.
...
Crea `.blackbox ai/skills/git-release/SKILL.md` así:
...
Blackbox AI enumera las habilidades disponibles en la descripción de la herramienta `skill`.
...
Controle a qué agentes de habilidades pueden acceder utilizando permisos basados ​​en patrones en `blackbox ai.json`:
...
**Para agentes integrados** (en `blackbox ai.json`):
