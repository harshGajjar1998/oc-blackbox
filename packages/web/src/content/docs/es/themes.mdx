...
Con Blackbox AI puede seleccionar uno de varios temas integrados, usar un tema que se adapte al tema de su terminal o definir su propio tema personalizado.

De forma predeterminada, Blackbox AI usa nuestro propio tema `blackbox ai`.
...
Blackbox AI viene con varios temas integrados.
...
- Quiere que Blackbox AI coincida con la apariencia de su terminal
...
Blackbox AI admite un sistema de temas flexible basado en JSON que permite a los usuarios crear y personalizar temas fácilmente.
...
2. **Directorio de configuración de usuario**: definido en `~/.config/blackbox ai/themes/*.json` o `$XDG_CONFIG_HOME/blackbox ai/themes/*.json`
3. **Directorio raíz del proyecto**: definido en `<project-root>/.blackbox ai/themes/*.json`
4. **Directorio de trabajo actual** - Definido en `./.blackbox ai/themes/*.json`
