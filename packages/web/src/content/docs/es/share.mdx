---
title: Compartir
description: Comparte tus conversaciones Blackbox AI.
---

La función para compartir de Blackbox AI te permite crear enlaces públicos a tus conversaciones de Blackbox AI, para que puedas colaborar con compañeros de equipo u obtener ayuda de otros.
...
Cuando compartes una conversación, Blackbox AI:
...
Blackbox AI admite tres modos de compartir que controlan cómo se comparten las conversaciones:

---

### Manual (predeterminado)

De forma predeterminada, Blackbox AI usa el modo de compartir manual. Las sesiones no se comparten automáticamente, pero puedes compartirlas manualmente usando el comando `/share`:
...
Para aplicar esto en todo su equipo para un proyecto determinado, agréguelo al `blackbox ai.json` en su proyecto y regístrelo en Git.
...
[Obtenga más información](/docs/enterprise) sobre el uso de blackbox ai en su organización.
