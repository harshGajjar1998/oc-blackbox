---
title: TUI
description: Using the Blackbox AI terminal user interface.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

Blackbox AI provides an interactive terminal interface or TUI for working on your projects with an LLM.

Running Blackbox AI starts the TUI for the current directory.
...
When using the Blackbox AI TUI, you can type `/` followed by a command name to quickly execute actions. For example:
