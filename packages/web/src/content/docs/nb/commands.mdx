...
Opprett `.blackbox ai/commands/test.md`:
...
Du kan legge til egendefinerte kommandoer gjennom Blackbox AI-konfigurasjonen eller ved å lage markdown-filer i katalogen `commands/`.

---

### JSON

Bruk alternativet `command` i Blackbox AI [config](/docs/config):
...
- Per prosjekt: `.blackbox ai/commands/`
...
Blackbox AI inkluderer flere innebygde kommandoer som `/init`, `/undo`, `/redo`, `/share`, `/help`; [finn ut mer](/docs/tui#commands).
