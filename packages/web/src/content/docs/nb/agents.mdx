...
Det er to typer agenter i Blackbox AI; primære agenter og underagenter.
...
Blackbox AI kommer med to innebygde primære agenter, **Build** og **Plan**. Vi ser nærmere på disse nedenfor.
...
Blackbox AI kommer med to innebygde underagenter, **General** og **Explore**. Vi skal se på dette nedenfor.

---

## Innebygd

Blackbox AI kommer med to innebygde primære agenter og to innebygde underagenter.
...
Konfigurer agenter i konfigurasjonsfilen `blackbox ai.json`:
...
- Globalt: `~/.config/blackbox ai/agents/`
- Per prosjekt: `.blackbox ai/agents/`
...
Hvis ingen temperatur er spesifisert, bruker Blackbox AI modellspesifikke standardinnstillinger; typisk 0 for de fleste modeller, 0,55 for Qwen-modeller.
...
Denne banen er i forhold til hvor konfigurasjonsfilen er plassert. Så dette fungerer for både den globale Blackbox AI-konfigurasjonen og den prosjektspesifikke konfigurasjonen.
...
Modellen ID i Blackbox AI-konfigurasjonen din bruker formatet `provider/model-id`. For eksempel, hvis du bruker [Blackbox AI Zen](/docs/zen), vil du bruke `blackbox ai/gpt-5.1-codex` for GPT 5.1 Codex.
...
:::tip
Kjør `blackbox ai models` for å se en liste over tilgjengelige modeller.
:::
...
:::tip
Har du en agent du vil dele? [Send inn en PR](https://github.com/anomalyco/blackbox ai).
:::
