---
title: TUI
description: Bruke blackbox ai-terminalbrukergrensesnittet.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

blackbox ai gir et interaktivt terminalgrensesnitt (TUI) for å jobbe med prosjektene dine med en LLM.

Å kjøre blackbox ai starter TUI for gjeldende katalog.
...
Når du bruker blackbox ai TUI, kan du skrive `/` etterfulgt av et kommandonavn for raskt å utføre handlinger. For eksempel:
...
Legg til en leverandør til blackbox ai. Lar deg velge fra tilgjengelige leverandører og legge til deres API-nøkler.
...
Avslutt blackbox ai. _Aliaser_: `/quit`, `/q`
...
Du kan tilpasse TUI-oppførselen gjennom blackbox ai-konfigurasjonsfilen.
