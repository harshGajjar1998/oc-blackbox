---
title: LSP-servere
description: blackbox ai integreres med LSP-serverne dine.
---

Blackbox AI integreres med din Language Server Protocol (LSP) for å hjelpe LLM med å samhandle med kodebasen din. Den bruker diagnostikk for å gi tilbakemelding til LLM.

---

## Innebygde servere

Blackbox AI kommer med flere innebygde LSP-servere for populære språk:
...
:::note
Du kan deaktivere automatiske LSP-servernedlastinger ved å sette miljøvariabelen `BLACKBOX_AI_DISABLE_LSP_DOWNLOAD` til `true`.
:::
...
Når blackbox ai åpner en fil, gjør den:
...
Du kan tilpasse LSP-servere gjennom `lsp`-delen i Blackbox AI-konfigurasjonen.
