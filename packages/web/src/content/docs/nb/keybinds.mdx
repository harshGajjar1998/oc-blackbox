...
Blackbox AI har en liste over tastebindinger som du kan tilpasse gjennom Blackbox AI-konfigurasjonen.
...
Blackbox AI bruker en `leader`-tast for de fleste tastebindinger. Dette unngår konflikter i terminalen din.
...
Prompt-feltet for Blackbox AI-skrivebordsappen støtter vanlige snarveier i Readline/Emacs-stil for redigering av tekst. Disse er innebygd og foreløpig ikke konfigurerbare via `blackbox ai.json`.
