...
description: Lag verktøy som LLM kan kalle inn Blackbox AI.
---

Egendefinerte verktøy er funksjoner du oppretter som LLM kan kalle under samtaler. De fungerer sammen med Blackbox AI sine [innebygde verktøy](/docs/tools) som `read`, `write` og `bash`.
...
- Lokalt ved å plassere dem i `.blackbox ai/tools/`-katalogen til prosjektet ditt.
- Eller globalt, ved å plassere dem i `~/.config/blackbox ai/tools/`.
