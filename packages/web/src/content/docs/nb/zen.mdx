---
title: Zen
description: Utvalgt liste over modeller levert av Blackbox AI.
---
...
Blackbox AI Zen er en liste over testede og verifiserte modeller levert av Blackbox AI-teamet.

:::note
Blackbox AI Zen er for øyeblikket i beta.
:::

Zen fungerer som alle andre leverandører i Blackbox AI. Du logger på Blackbox AI Zen og får
...
:::tip
Vi testet en utvalgt gruppe modeller og leverandører som fungerer godt med Blackbox AI.
:::
...
Blackbox AI Zen er en AI gateway som gir deg tilgang til disse modellene.

---

## Slik fungerer det

Blackbox AI Zen fungerer som alle andre leverandører i Blackbox AI.

1. Du logger på **<a href={console}>Blackbox AI Zen</a>**, legg til fakturering
   detaljer, og kopier API-nøkkelen.
2. Du kjører kommandoen `/connect` i TUI, velger Blackbox AI Zen og limer inn API-nøkkelen.
...
[modell-id](/docs/config/#models) i Blackbox AI-konfigurasjonen
bruker formatet `blackbox ai/<model-id>`. For eksempel, for GPT 5.2 Codex, ville du
bruk `blackbox ai/gpt-5.2-codex` i konfigurasjonen din.
...
- GLM 4.7 Free er tilgjengelig på Blackbox AI i en begrenset periode. Teamet bruker denne tiden til å samle tilbakemeldinger og forbedre modellen.
- Kimi K2.5 Free er tilgjengelig på Blackbox AI i en begrenset periode. Teamet bruker denne tiden til å samle tilbakemeldinger og forbedre modellen.
- MiniMax M2.1 Free er tilgjengelig på Blackbox AI i en begrenset periode. Teamet bruker denne tiden til å samle tilbakemeldinger og forbedre modellen.
- Big Pickle er en stealth-modell som er gratis på Blackbox AI i en begrenset periode. Teamet bruker denne tiden til å samle tilbakemeldinger og forbedre modellen.
...
Vi opprettet Blackbox AI Zen for å:
...
4. Ha **ingen låsing** ved å la deg bruke den med en hvilken som helst annen kodeagent. Og la deg alltid bruke en hvilken som helst annen leverandør med blackbox ai også.
