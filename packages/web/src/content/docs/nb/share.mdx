---
title: Deling
description: Del dine Blackbox AI-samtaler.
---

Delingsfunksjonen i Blackbox AI lar deg lage offentlige lenker til dine Blackbox AI-samtaler, slik at du kan samarbeide med lagkamerater eller få hjelp fra andre.
...
Når du deler en samtale, Blackbox AI:
...
Blackbox AI støtter tre delingsmoduser som kontrollerer hvordan samtaler deles:

---

### Manuell (standard)

Som standard bruker Blackbox AI manuell delingsmodus. Økter deles ikke automatisk, men du kan dele dem manuelt ved å bruke kommandoen `/share`:
...
For å håndheve dette på tvers av teamet ditt for et gitt prosjekt, legg det til `blackbox ai.json` i prosjektet ditt og sjekk det inn i Git.
...
[Finn ut mer](/docs/enterprise) om bruk av blackbox ai i organisasjonen din.
