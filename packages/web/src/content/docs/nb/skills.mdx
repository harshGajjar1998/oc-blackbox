...
Agentferdigheter lar Blackbox AI oppdage gjenbrukbare instruksjoner fra repo- eller hjemmekatalogen din.
...
For prosjektlokale stier går blackbox ai opp fra din nåværende arbeidskatalog til den når git-arbeidstreet.
...
blackbox ai viser tilgjengelige ferdigheter i `skill`-verktøybeskrivelsen.
...
Kontroller hvilke ferdigheter agenter har tilgang til ved å bruke mønsterbaserte tillatelser i `blackbox ai.json`:
