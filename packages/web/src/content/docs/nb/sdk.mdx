---
title: SDK
description: Typesikker JS-klient for Blackbox AI-server.
---

import config from "../../../../config.mjs"
export const typesUrl = `${config.github}/blob/dev/packages/sdk/js/src/gen/types.gen.ts`

Blackbox AI JS/TS SDK gir en typesikker klient for samhandling med serveren.
Bruk den til å bygge integrasjoner og kontrollere Blackbox AI programmatisk.
...
Opprett en forekomst av Blackbox AI:
...
Du kan sende et konfigurasjonsobjekt for å tilpasse virkemåten. Forekomsten henter fortsatt din `blackbox ai.json`, men du kan overstyre eller legge til konfigurasjon inline:
...
Hvis du allerede har en kjørende forekomst av Blackbox AI, kan du opprette en klientforekomst for å koble til den:
