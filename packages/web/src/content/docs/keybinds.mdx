...
Blackbox AI has a list of keybinds that you can customize through the Blackbox AI config.
...
Blackbox AI uses a `leader` key for most keybinds. This avoids conflicts in your terminal.
...
The Blackbox AI desktop app prompt input supports common Readline/Emacs-style shortcuts for editing text. These are built-in and currently not configurable via `blackbox ai.json`.
