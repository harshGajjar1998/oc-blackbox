...
Erstellen Sie `.blackbox ai/commands/test.md`:

```md title=".blackbox ai/commands/test.md"
---
...
Sie können benutzerdefinierte Befehle über die Blackbox AI-Konfiguration hinzufügen oder indem Sie Markdown-Dateien im Verzeichnis `commands/` erstellen.

---

### JSON

Verwenden Sie die Option `command` in Ihrem Blackbox AI [config](/docs/config):

```json title="blackbox ai.jsonc" {4-12}
{
...
- Global: `~/.config/blackbox ai/commands/`
- Pro Projekt: `.blackbox ai/commands/`

```markdown title="~/.config/blackbox ai/commands/test.md"
---
description: Run tests with coverage
agent: build
model: anthropic/claude-3-5-sonnet-20241022
...
```md title=".blackbox ai/commands/component.md"
---
...
```md title=".blackbox ai/commands/create-file.md"
---
...
```md title=".blackbox ai/commands/analyze-coverage.md"
---
...
```md title=".blackbox ai/commands/review-changes.md"
---
...
```md title=".blackbox ai/commands/review-component.md"
---
...
Blackbox AI enthält mehrere integrierte Befehle wie `/init`, `/undo`, `/redo`, `/share`, `/help`; [mehr erfahren](/docs/tui#commands).
