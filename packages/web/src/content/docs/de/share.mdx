---
title: Teilen
description: Teile Blackbox AI-Unterhaltungen per oeffentlichem Link.
---

Mit der Share-Funktion erstellst du oeffentliche Links zu Blackbox AI-Unterhaltungen.
...
Wenn du eine Unterhaltung teilst, macht Blackbox AI Folgendes:
...
Blackbox AI hat drei Modi, die das Teilen steuern:

---

### Manuell (Standard)

Standardmaessig nutzt Blackbox AI den manuellen Modus.
...
Wenn das fuer ein Projekt teamweit gelten soll, lege es in der Projekt-`blackbox ai.json` fest und committe die Datei.
...
[Mehr dazu](/docs/enterprise), wie du blackbox ai in deiner Organisation einsetzt.
