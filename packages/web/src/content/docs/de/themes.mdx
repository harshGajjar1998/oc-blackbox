...
Mit Blackbox AI kannst du ein eingebautes Theme waehlen, ein an dein Terminal angepasstes Theme nutzen oder ein eigenes Theme definieren.

Standardmaessig verwendet Blackbox AI das `blackbox ai`-Theme.
...
Blackbox AI liefert mehrere eingebaute Themes mit.
...
- Blackbox AI optisch ans Terminal anpassen wollen
...
Blackbox AI unterstuetzt ein flexibles JSON-basiertes Theme-System.
