---
title: Zen
description: Kuratierte Modellliste direkt von Blackbox AI.
---
...
Blackbox AI Zen ist eine vom Blackbox AI-Team getestete und verifizierte Modellliste.

:::note
Blackbox AI Zen befindet sich aktuell in der Beta.
:::

Zen funktioniert wie jeder andere Provider in Blackbox AI.
Du meldest dich bei Blackbox AI Zen an, holst dir deinen API-Key und nutzt ihn optional.
...
:::tip
Wir haben eine Auswahl aus Modellen und Providern getestet, die gut mit Blackbox AI funktionieren.
:::
...
Blackbox AI Zen ist ein AI-Gateway, das dir Zugriff auf genau diese Modelle gibt.

---

## Funktionsweise

Blackbox AI Zen funktioniert wie jeder andere Provider in Blackbox AI.

1. Melde dich bei **<a href={console}>Blackbox AI Zen</a>** an, hinterlege Zahlungsdaten und kopiere deinen API-Key.
2. Fuehre in der TUI `/connect` aus, waehle Blackbox AI Zen und fuege den API-Key ein.
...
Die [Model-ID](/docs/config/#models) in deiner Blackbox AI-Konfiguration hat das Format `blackbox ai/<model-id>`.
Fuer GPT 5.2 Codex verwendest du zum Beispiel `blackbox ai/gpt-5.2-codex`.
...
Wir haben Blackbox AI Zen entwickelt, um:
...
4. **Kein Lock-in** zu erzwingen, damit du Zen mit anderen Coding-Agents und Blackbox AI weiter mit anderen Providern nutzen kannst
