---
title: TUI
description: Arbeite mit Blackbox AI in der Terminal-Oberflaeche.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

Blackbox AI bietet eine interaktive Terminaloberflaeche (TUI), um mit einem LLM an deinen Projekten zu arbeiten.

Ohne weitere Argumente startet Blackbox AI die TUI im aktuellen Verzeichnis.
...
In der Blackbox AI-TUI kannst du `/` plus Befehlsnamen eingeben, um Aktionen schnell auszufuehren.
Zum Beispiel:
...
Add a provider to Blackbox AI. Allows you to select from available providers and add their API keys.
...
Exit Blackbox AI. _Aliases_: `/quit`, `/q`
...
You can customize TUI behavior through your Blackbox AI config file.
