---
title: Zen
description: Udvalgt liste over modeller leveret af Blackbox AI.
---
...
Blackbox AI Zen er en liste over testede og verificerede modeller leveret af Blackbox AI-teamet.

:::note
Blackbox AI Zen er i øjeblikket i beta.
:::

Zen fungerer som alle andre udbydere i Blackbox AI. Du logger på Blackbox AI Zen og får
...
:::tip
Vi testede en udvalgt gruppe modeller og udbydere, der fungerer godt med Blackbox AI.
:::
...
Blackbox AI Zen er en AI gateway, der giver dig adgang til disse modeller.

---

## Sådan fungerer det

Blackbox AI Zen fungerer som alle andre udbydere i Blackbox AI.

1. Du logger på **<a href={console}>Blackbox AI Zen</a>**, tilføjer faktureringsoplysninger
   og kopierer API-nøglen.
2. Du kører kommandoen `/connect` i TUI, vælger Blackbox AI Zen og indsætter API-nøglen.
...
| Claude Sonnet 4.5   | claude-sonnett-4-5 | `https://www.blackbox.ai/zen/v1/messages`              | `@ai-sdk/anthropic`         |
| Claude Sonnet 4     | claude-sonnett-4   | `https://www.blackbox.ai/zen/v1/messages`              | `@ai-sdk/anthropic`         |
...
| MiniMax M2.1 Gratis | minimax-m2.1-free  | `https://www.blackbox.ai/zen/v1/messages`              | `@ai-sdk/anthropic`         |
| GLM 4.7             | glm-4.7            | `https://www.blackbox.ai/zen/v1/chat/completions`      | `@ai-sdk/openai-compatible` |
| GLM 4.7 Gratis      | glm-4.7-free       | `https://www.blackbox.ai/zen/v1/chat/completions`      | `@ai-sdk/openai-compatible` |
...
| Kimi K2.5 Gratis    | kimi-k2.5-free     | `https://www.blackbox.ai/zen/v1/chat/completions`      | `@ai-sdk/openai-compatible` |
| Kimi K2 Tenker      | kimi-k2-thinking   | `https://www.blackbox.ai/zen/v1/chat/completions`      | `@ai-sdk/openai-compatible` |
| Kimi K2             | kimi-k2            | `https://www.blackbox.ai/zen/v1/chat/completions`      | `@ai-sdk/openai-compatible` |
| Qwen3-koder 480B    | qwen3-coder        | `https://www.blackbox.ai/zen/v1/chat/completions`      | `@ai-sdk/openai-compatible` |
| Stor sylteagurk     | big-pickle         | `https://www.blackbox.ai/zen/v1/chat/completions`      | `@ai-sdk/openai-compatible` |

[model-id](/docs/config/#models) i Blackbox AI-konfigurationen
bruger formatet `blackbox ai/<model-id>`. For eksempel, for GPT 5.2 Codex, ville du
bruge `blackbox ai/gpt-5.2-codex` i din konfiguration.
...
- GLM 4.7 Gratis er tilgængelig på Blackbox AI i en begrænset periode. Teamet bruger denne tid til at samle feedback og forbedre modellen.
- Kimi K2.5 Gratis er tilgængelig på Blackbox AI i en begrænset periode. Teamet bruger denne tid til at samle feedback og forbedre modellen.
- MiniMax M2.1 Gratis er tilgængelig på Blackbox AI i en begrænset periode. Teamet bruger denne tid til at samle feedback og forbedre modellen.
- Stor sylteagurk er en stealth-model som er gratis på Blackbox AI i en begrænset periode. Teamet bruger denne tid til at samle feedback og forbedre modellen.
...
Vi oprettede Blackbox AI Zen for at:
...
4. Have **ingen fastlåsning** ved at lade dig bruge den med en hvilken som helst anden kodeagent. Og lade dig altid bruge en hvilken som helst anden udbyder med Blackbox AI også.
