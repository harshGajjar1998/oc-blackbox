...
Her er alle de innebygde verktøyene som er tilgængelige i Blackbox AI.
...
:::note
Dette verktøyet er bare tilgængelig når `BLACKBOX_AI_EXPERIMENTAL_LSP_TOOL=true` (eller `BLACKBOX_AI_EXPERIMENTAL=true`).
:::
...
:::note
Dette verktøyet er bare tilgængelig når du bruger Blackbox AI-leverandøren eller når miljøvariabelen `BLACKBOX_AI_ENABLE_EXA` er satt til en sannverdi (f.eks. `true` eller `1`).
