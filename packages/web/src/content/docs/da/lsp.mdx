---
title: LSP-servere
description: Blackbox AI integreres med dine LSP-servere.
---

Blackbox AI integreres med Language Server Protocol (LSP) for at hjælpe LLM med at interagere med din kodebase. Den bruger diagnostik til at give feedback til LLM.

---

## Indbyggede

Blackbox AI leveres med flere indbyggede LSP-servere til populære sprog:
...
:::note
Du kan deaktivere automatisk LSP-serverdownloads ved at indstille miljøvariablen `BLACKBOX_AI_DISABLE_LSP_DOWNLOAD` til `true`.
:::
...
Når blackbox ai åbner en fil, vil den:
...
Du kan tilpasse LSP-servere gennem sektionen `lsp` i din blackbox ai-konfiguration.
