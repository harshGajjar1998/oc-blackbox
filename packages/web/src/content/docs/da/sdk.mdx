...
Brug den til at bygge integrasjoner og kontrollere blackbox ai programmatisk.
...
Opret en forekomst av blackbox ai:
...
Du kan sende et konfigurasjonsobjekt for at tilpasse virkemåten. Forekomsten henter fortsatt din `blackbox ai.json`, men du kan overstyre eller tilføje til konfigurasjon inline:
...
Hvis du allerede har en kjørende forekomst av blackbox ai, kan du oprete en klientforekomst for at koble til den:
