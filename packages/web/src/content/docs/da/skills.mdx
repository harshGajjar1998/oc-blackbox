...
Agentferdigheter lar Blackbox AI oppdage gjenbrugbare instruksjoner fra repo- eller hjemmekatalogen din.
...
Blackbox AI søker etter disse stedene:

- Prosjektkonfigurasjon: `.blackbox ai/skills/<name>/SKILL.md`
- Global konfigurasjon: `~/.config/blackbox ai/skills/<name>/SKILL.md`
...
For prosjektlokale stier går Blackbox AI opp fra din nåværende arbejdskatalog til den når git-arbeidstreet.
Den laster alle matchende `skills/*/SKILL.md` i `.blackbox ai/` og alle matchende `.claude/skills/*/SKILL.md` eller `.agents/skills/*/SKILL.md` underveis.

Globale definisjoner lastes også inn fra `~/.config/blackbox ai/skills/*/SKILL.md`, `~/.claude/skills/*/SKILL.md` og `~/.agents/skills/*/SKILL.md`.
...
Lag `.blackbox ai/skills/git-release/SKILL.md` slik:
...
Blackbox AI viser tilgængelige ferdigheter i `skill` verktøybeskrivelsen.
...
Kontroller hvilke ferdigheter agenter har tilgang til ved at bruge mønsterbaserte tillatelser i `blackbox ai.json`:
...
**For innebygde agenter** (i `blackbox ai.json`):
