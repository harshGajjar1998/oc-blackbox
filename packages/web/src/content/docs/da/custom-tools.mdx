...
description: Opret værktøjer, som LLM kan kalde blackbox ai ind.
---

Brugerdefinerede værktøjer er funktioner, du opretter, som LLM kan kalde under samtaler. De arbejder sammen med blackbox ais [built-in tools](/docs/tools) som `read`, `write` og `bash`.
...
- Lokalt ved at placere dem i biblioteket `.blackbox ai/tools/` i dit projekt.
- Eller globalt ved at placere dem i `~/.config/blackbox ai/tools/`.
