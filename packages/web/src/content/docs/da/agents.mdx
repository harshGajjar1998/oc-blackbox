...
Der er to typer agenter i Blackbox AI; primære agenter og subagenter.
...
Blackbox AI leveres med indbyggede primære agenter, **Build** og **Plan**. Vi vil
...
Blackbox AI leveres med to indbyggede underagenter, **Generelt** og **Udforsk**. Vi vil se på dette nedenfor.

---

## Indbyggede

Blackbox AI leveres med to indbyggede primære agenter og to indbyggede subagenter.
...
Konfigurer agent i din `blackbox ai.json`-konfigurationsfil:
...
Hvis ingen temperatur er angivet, bruger Blackbox AI modelspecifikke standardindstillinger; typisk 0 for de fleste modeller, 0,55 for Qwen-modeller.
...
Denne sti er i forhold til, hvor konfigurationsfilen er placeret. Så dette virker både for den globale Blackbox AI-konfiguration og den projektspecifikke konfiguration.
...
Model-id'et i din Blackbox AI-konfiguration brugerformatet `provider/model-id`. For eksempel, hvis du bruger [Blackbox AI Zen](/docs/zen), vil du bruge `blackbox ai/gpt-5.1-codex` til GPT 5.1 Codex.
...
:::tip
Kør `blackbox ai models` for at se en liste over de tilgængelige modeller.
:::
...
:::tip
Har du en agent, du gerne vil dele? [Send en PR](https://github.com/anomalyco/blackbox ai).
:::
