---
title: TUI
description: Korištenje korisničkog interfejsa Blackbox AI terminala.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

Blackbox AI pruža interaktivni terminalski interfejs ili TUI za rad na vašim projektima sa LLM.

Pokretanje Blackbox AI pokreće TUI za trenutni direktorij.
...
Kada koristite Blackbox AI TUI, možete upisati `/` nakon čega slijedi ime komande da biste brzo izvršili radnje. na primjer:
...
Dodajte provajdera u Blackbox AI. Omogućava vam da odaberete između dostupnih provajdera i dodate njihove API ključeve.
...
Izađite iz Blackbox AI. _Aliases_: `/quit`, `/q`
...
Možete prilagoditi TUI ponašanje putem vašeg Blackbox AI konfiguracionog fajla.
