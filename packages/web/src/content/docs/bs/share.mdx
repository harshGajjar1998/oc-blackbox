---
title: Dijeljenje
description: Dijelite Blackbox AI razgovore javnim linkovima.
---

Blackbox AI opcija dijeljenja vam omogucava da kreirate javne linkove za razgovore. Tako lakse saradujete s timom ili trazite pomoc od drugih.
...
Kada podijelite razgovor, Blackbox AI:
...
Blackbox AI podrzava tri nacina dijeljenja koji odreduju kako se razgovori dijele:

---

### Ručno (zadano)

Po defaultu, Blackbox AI koristi rucni nacin dijeljenja. Sesije se ne dijele automatski, ali ih mozete rucno podijeliti komandom `/share`:
...
Da ovo vazi za cijeli tim u odredenom projektu, dodajte postavku u projektni `blackbox ai.json` i commitujte u Git.
...
[Saznajte vise](/docs/enterprise) o koristenju blackbox ai u organizaciji.
