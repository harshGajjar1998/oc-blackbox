...
Kreiraj `.blackbox ai/commands/test.md`:
...
Možete dodati prilagođene komande kroz Blackbox AI konfiguraciju ili kreiranjem markdown datoteka u direktoriju `commands/`.

---

### JSON

Koristite opciju `command` u svom Blackbox AI [config](/docs/config):
...
- Globalno: `~/.config/blackbox ai/commands/`
- Po projektu: `.blackbox ai/commands/`
...
Blackbox AI uključuje nekoliko ugrađenih naredbi kao što su `/init`, `/undo`, `/redo`, `/share`, `/help`; [saznaj više](/docs/tui#commands).
:::note
