...
Postoje dvije vrste agenata u Blackbox AI: primarni agenti i podagenti.
...
Blackbox AI dolazi sa dva ugrađena primarna agenta, **Build** i **Plan**. Pogledat ćemo ih u nastavku.
...
Blackbox AI dolazi sa dva ugrađena subagenta, **General** i **Explore**. Ovo ćemo pogledati u nastavku.

---

## Ugrađeni

Blackbox AI dolazi sa dva ugrađena primarna agenta i dva ugrađena subagenta.
...
Konfigurirajte agente u svom konfiguracijskom fajlu `blackbox ai.json`:
...
- Globalno: `~/.config/blackbox ai/agents/`
- Po projektu: `.blackbox ai/agents/`
...
Ako temperatura nije navedena, Blackbox AI koristi standardne postavke specifične za model; obično 0 za većinu modela, 0.55 za Qwen modele.
...
Ova putanja je relativna u odnosu na mjesto gdje se nalazi konfiguracijski fajl. Dakle, ovo radi i za globalnu Blackbox AI konfiguraciju i za konfiguraciju specifične za projekat.
...
ID modela u vašoj Blackbox AI konfiguraciji koristi format `provider/model-id`. Na primjer, ako koristite [Blackbox AI Zen](/docs/zen), koristili biste `blackbox ai/gpt-5.1-codex` za GPT 5.1 Codex.
...
:::tip
Pokrenite `blackbox ai models` da vidite listu dostupnih modela.
:::
...
:::tip
Imate li agenta kojeg biste željeli podijeliti? [Pošalji PR](https://github.com/anomalyco/blackbox ai).
:::
