---
title: SDK
description: Type-safe JS klijent za blackbox ai server.
---

import config from "../../../../config.mjs"
export const typesUrl = `${config.github}/blob/dev/packages/sdk/js/src/gen/types.gen.ts`

blackbox ai JS/TS SDK pruza type-safe klijent za interakciju sa serverom.
Koristite ga za izradu integracija i programsko upravljanje blackbox ai-om.
...
Kreirajte instancu blackbox ai:
...
Mozete proslijediti konfiguracijski objekat za prilagodavanje ponasanja. Instanca i dalje ucitava `blackbox ai.json`, ali konfiguraciju mozete nadjacati ili dodati inline:
...
Ako vec imate pokrenutu blackbox ai instancu, mozete napraviti klijentsku instancu i povezati se na nju:
