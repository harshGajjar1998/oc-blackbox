...
Agent skills omogucavaju Blackbox AI da pronade uputstva koja se mogu ponovo koristiti iz repozitorija ili home direktorija.
...
Blackbox AI pretrazuje ove lokacije:

- Konfiguracija projekta: `.blackbox ai/skills/<name>/SKILL.md`
- Globalna konfiguracija: `~/.config/blackbox ai/skills/<name>/SKILL.md`
...
Za projektne lokalne putanje, Blackbox AI ide prema gore od trenutnog radnog direktorija dok ne dode do git worktree-ja.
Usput ucitava sve odgovarajuce `skills/*/SKILL.md` u `.blackbox ai/` i odgovarajuce `.claude/skills/*/SKILL.md` ili `.agents/skills/*/SKILL.md`.

Globalne definicije se takoder ucitavaju iz `~/.config/blackbox ai/skills/*/SKILL.md`, `~/.claude/skills/*/SKILL.md` i `~/.agents/skills/*/SKILL.md`.
...
Kreirajte `.blackbox ai/skills/git-release/SKILL.md` ovako:
...
Blackbox AI navodi dostupne skills u opisu `skill` alata.
...
Kontrolisite kojim skills agenti mogu pristupiti pomocu dozvola baziranih na obrascima u `blackbox ai.json`:
...
**Za ugradene agente** (u `blackbox ai.json`):
