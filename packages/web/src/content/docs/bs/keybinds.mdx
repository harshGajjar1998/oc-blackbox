...
Blackbox AI ima listu veza tipki koje možete prilagoditi preko Blackbox AI konfiguracije.
...
Blackbox AI koristi `leader` (vodeću) tipku za većinu povezivanja tipki. Ovo izbjegava sukobe u vašem terminalu.
...
Unos prompta aplikacije Blackbox AI za desktop podržava uobičajene prečice u stilu Readline/Emacs za uređivanje teksta. One su ugrađene i trenutno se ne mogu konfigurirati putem `blackbox ai.json`.
