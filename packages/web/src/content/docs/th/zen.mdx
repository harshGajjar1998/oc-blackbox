---
title: เซน
description: รายการโมเดลที่คัดสรรโดย Blackbox AI
---
...
Blackbox AI Zen คือรายการโมเดลที่ได้รับการทดสอบและตรวจสอบแล้วโดยทีมงาน Blackbox AI

:::note
Blackbox AI Zen ปัจจุบันอยู่ในช่วงเบต้า
:::

Zen ทำงานเหมือนกับผู้ให้บริการรายอื่นๆ ใน Blackbox AI คุณเข้าสู่ระบบ Blackbox AI Zen และรับ
...
:::tip
เราได้ทดสอบกลุ่มโมเดลและผู้ให้บริการที่เลือกซึ่งทำงานได้ดีกับ Blackbox AI
:::
...
Blackbox AI Zen เป็นเกตเวย์ AI ที่ให้คุณเข้าถึงโมเดลเหล่านี้

---

## มันทำงานอย่างไร

Blackbox AI Zen ทำงานเหมือนกับผู้ให้บริการรายอื่นๆ ใน Blackbox AI

1. คุณลงชื่อเข้าใช้ **<a href={console}>Blackbox AI Zen</a>** เพิ่มการเรียกเก็บเงินของคุณ
   รายละเอียดและคัดลอกรหัส API ของคุณ
2. คุณรันคำสั่ง `/connect` ใน TUI เลือก Blackbox AI Zen และวางคีย์ API ของคุณ
...
| Claude Haiku 3.5   | claude-haiku-3-5   | `https://www.blackbox.ai/zen/v1/messages`              | `@ai-sdk/anthropic`         |
...
[model id](/docs/config/#models) ในการกำหนดค่า Blackbox AI ของคุณ
ใช้รูปแบบ `blackbox ai/<model-id>` ตัวอย่างเช่น สำหรับ GPT 5.2 Codex คุณจะต้อง
ใช้ `blackbox ai/gpt-5.2-codex` ในการกำหนดค่าของคุณ
...
- GLM 4.7 ใช้งานได้ฟรีบน Blackbox AI ในระยะเวลาจำกัด ทีมงานใช้เวลานี้เพื่อรวบรวมคำติชมและปรับปรุงโมเดล
- Kimi K2.5 Free พร้อมใช้งานบน Blackbox AI ในระยะเวลาจำกัด ทีมงานใช้เวลานี้เพื่อรวบรวมคำติชมและปรับปรุงโมเดล
- MiniMax M2.1 Free พร้อมใช้งานบน Blackbox AI ในระยะเวลาจำกัด ทีมงานใช้เวลานี้เพื่อรวบรวมคำติชมและปรับปรุงโมเดล
- Big Pickle เป็นโมเดลล่องหนที่ให้บริการฟรีบน Blackbox AI ในระยะเวลาจำกัด ทีมงานใช้เวลานี้เพื่อรวบรวมคำติชมและปรับปรุงโมเดล
...
เราสร้าง Blackbox AI Zen เพื่อ:
...
4. **ไม่มีการล็อคอิน** โดยอนุญาตให้คุณใช้กับเอเจนต์การเขียนโค้ดอื่นๆ และให้คุณใช้ผู้ให้บริการรายอื่นกับ Blackbox AI ได้เช่นกัน
