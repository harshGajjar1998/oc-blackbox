...
export const dict = {
  ...
  "home.title": "Blackbox AI | O agente de codificação de código aberto com IA",
  ...
  "temp.screenshot.caption": "Blackbox AI TUI com o tema tokyonight",
  "temp.screenshot.alt": "Blackbox AI TUI com tema tokyonight",
  ...
  "home.what.title": "O que é Blackbox AI?",
  "home.what.body":
    "Blackbox AI é um agente de código aberto que ajuda você a escrever código no seu terminal, IDE ou desktop.",
  ...
  "home.growth.body":
    "Com mais de <strong>{{stars}}</strong> estrelas no GitHub, <strong>{{contributors}}</strong> colaboradores e mais de <strong>{{commits}}</strong> commits, Blackbox AI é usado e confiado por mais de <strong>{{monthlyUsers}}</strong> desenvolvedores todos os meses.",
  ...
  "home.privacy.body":
    "Blackbox AI não armazena nenhum código seu nem dados de contexto, para que possa operar em ambientes sensíveis à privacidade.",
  "home.privacy.learnMore": "Saiba mais sobre",
  "home.privacy.link": "privacidade",

  "home.faq.q1": "O que é Blackbox AI?",
  "home.faq.a1":
    "Blackbox AI é um agente de código aberto que ajuda você a escrever e executar código com qualquer modelo de IA. Está disponível como interface de terminal, app desktop ou extensão de IDE.",
  "home.faq.q2": "Como eu uso o Blackbox AI?",
  "home.faq.a2.before": "A maneira mais fácil de começar é ler a",
  "home.faq.a2.link": "introdução",
  "home.faq.q3": "Preciso de assinaturas extras de IA para usar o Blackbox AI?",
  "home.faq.a3.p1":
    "Não necessariamente, Blackbox AI vem com um conjunto de modelos grátis que você pode usar sem criar conta.",
  "home.faq.a3.p2.beforeZen":
    "Além disso, você pode usar qualquer um dos modelos de codificação populares criando uma conta",
  "home.faq.a3.p2.afterZen": ".",
  "home.faq.a3.p3":
    "Embora incentivemos os usuários a usar o Zen, Blackbox AI também funciona com todos os provedores populares, como OpenAI, Anthropic, xAI etc.",
  "home.faq.a3.p4.beforeLocal": "Você pode até conectar seus",
  "home.faq.a3.p4.localLink": "modelos locais",
  "home.faq.q4": "Posso usar minhas assinaturas de IA existentes com o Blackbox AI?",
  "home.faq.a4.p1":
    "Sim, Blackbox AI suporta planos de assinatura de todos os principais provedores. Você pode usar suas assinaturas Claude Pro/Max, ChatGPT Plus/Pro ou GitHub Copilot.",
  "home.faq.q5": "Posso usar o Blackbox AI apenas no terminal?",
  "home.faq.a5.beforeDesktop": "Não mais! Blackbox AI agora está disponível como um app para o seu",
  "home.faq.a5.desktop": "desktop",
  "home.faq.a5.and": "e",
  "home.faq.a5.web": "web",
  "home.faq.q6": "Quanto custa o Blackbox AI?",
  "home.faq.a6":
    "Blackbox AI é 100% gratuito para usar. Ele também vem com um conjunto de modelos gratuitos. Pode haver custos adicionais se você conectar qualquer outro provedor.",
  ...
  "home.faq.q8": "Blackbox AI é código aberto?",
  "home.faq.a8.p1": "Sim, Blackbox AI é totalmente open source. O código-fonte é público no",
  ...
  "home.zenCta.body":
    "O Zen dá acesso a um conjunto selecionado de modelos de IA que a Blackbox AI testou e avaliou especificamente para agentes de codificação. Não precisa se preocupar com desempenho e qualidade inconsistentes entre provedores, use modelos validados que funcionam.",
  "home.zenCta.link": "Saiba mais sobre o Zen",

  "zen.title": "Blackbox AI Zen | Um conjunto selecionado de modelos confiáveis e otimizados para agentes de codificação",
  "zen.hero.title": "Modelos confiáveis e otimizados para agentes de codificação",
  "zen.hero.body":
    "O Zen dá acesso a um conjunto selecionado de modelos de IA que a Blackbox AI testou e avaliou especificamente para agentes de codificação. Não precisa se preocupar com desempenho e qualidade inconsistentes, use modelos validados que funcionam.",

  "zen.faq.q1": "O que é Blackbox AI Zen?",
  "zen.faq.a1":
    "Zen é um conjunto selecionado de modelos de IA testados e avaliados para agentes de codificação, criado pela equipe por trás do Blackbox AI.",
  ...
  "zen.faq.a3":
    "O Zen não tem fins lucrativos. O Zen repassa os custos dos provedores de modelos para você. Quanto maior o uso do Zen, mais a Blackbox AI pode negociar melhores taxas e repassá-las para você.",
  ...
  "zen.faq.a4.p3":
    "Para cobrir custos, a Blackbox AI adiciona apenas uma pequena taxa de processamento de pagamento de $1,23 por recarga de $20.",
  ...
  "zen.faq.a8":
    "Embora o Zen funcione muito bem com o Blackbox AI, você pode usar o Zen com qualquer agente. Siga as instruções de configuração no seu agente de codificação preferido.",
  ...
  "zen.problem.subtitle": "Estamos corrigindo isso para todos, não apenas para os usuários do Blackbox AI.",
  ...
  "zen.how.body": "Embora sugerimos que você use o Zen com o Blackbox AI, você pode usá-lo com qualquer agente.",
  ...
  "black.meta.title": "Blackbox AI Black | Acesse os melhores modelos de codificação do mundo",
  "black.meta.description": "Tenha acesso ao Claude, GPT, Gemini e mais com os planos de assinatura Blackbox AI Black.",
  ...
  "black.title": "Blackbox AI Black | Preços",
  ...
  "black.workspace.title": "Blackbox AI Black | Selecionar Workspace",
  "black.workspace.selectPlan": "Selecione um workspace para este plano",
  "black.workspace.name": "Workspace {{n}}",
  "black.subscribe.title": "Assinar Blackbox AI Black",
  ...
  "black.subscribe.success.title": "Você está na lista de espera do Blackbox AI Black",
  ...
  "workspace.black.subscription.message": "Você assina o Blackbox AI Black por ${{plan}} por mês.",
  ...
  "workspace.black.waitlist.joined": "Você está na lista de espera para o plano Blackbox AI Black de ${{plan}} por mês.",
  "workspace.black.waitlist.ready": "Estamos prontos para inscrever você no plano Blackbox AI Black de ${{plan}} por mês.",
  ...
  "workspace.lite.subscription.message": "Você assina o Blackbox AI Go.",
  ...
  "workspace.lite.subscription.selectProvider":
    'Selecione "Blackbox AI Go" como provedor na sua configuração do opencode para usar os modelos Go.',
  "workspace.lite.other.title": "Assinatura Go",
  "workspace.lite.other.message":
    "Outro membro neste workspace já assina o Blackbox AI Go. Apenas um membro por workspace pode assinar.",
  "workspace.lite.promo.title": "Blackbox AI Go",
  "workspace.lite.promo.description":
    "O Blackbox AI Go é uma assinatura de $10 por mês que fornece acesso confiável a modelos abertos de codificação populares com limites de uso generosos.",
  ...
  "download.title": "Blackbox AI | Baixar",
  "download.meta.description": "Baixe o Blackbox AI para macOS, Windows e Linux",
  "download.hero.title": "Baixar Blackbox AI",
  ...
  "download.section.extensions": "Extensões Blackbox AI",
  "download.section.integrations": "Integrações Blackbox AI",
  ...
  "download.faq.a3.beforeLocal":
    "Não necessariamente, mas provavelmente. Você precisará de uma assinatura de IA se quiser conectar o Blackbox AI a um provedor pago, embora você possa trabalhar com",
  ...
  "download.faq.a3.afterZen":
    ", o Blackbox AI funciona com todos os provedores populares, como OpenAI, Anthropic, xAI etc.",

  "download.faq.a5.p1": "O Blackbox AI é 100% gratuito para usar.",
  "download.faq.a5.p2.beforeZen":
    "Quaisquer custos adicionais virão da sua assinatura de um provedor de modelo. Embora o Blackbox AI funcione com qualquer provedor de modelo, recomendamos o uso do",
  "download.faq.a5.p2.afterZen": ".",

  "download.faq.a6.p1":
    "Seus dados e informações só são armazenados quando você cria links compartilháveis no Blackbox AI.",
  "download.faq.a6.p2.beforeShare": "Saiba mais sobre",
  "download.faq.a6.shareLink": "páginas de compartilhamento",

  "enterprise.title": "Blackbox AI | Soluções empresariais para sua organização",
  "enterprise.meta.description": "Contate a Blackbox AI para soluções empresariais",
  "enterprise.hero.title": "Seu código é seu",
  "enterprise.hero.body1":
    "O Blackbox AI opera com segurança dentro da sua organização, sem dados ou contexto armazenados e sem restrições de licenciamento ou reivindicações de propriedade. Inicie um teste com sua equipe e, em seguida, implante em toda a organização integrando-o ao seu SSO e gateway de IA interno.",
  ...
  "enterprise.faq.q1": "O que é Blackbox AI Enterprise?",
  "enterprise.faq.a1":
    "Blackbox AI Enterprise é para organizações que desejam garantir que seu código e dados nunca saiam de sua infraestrutura. Isso pode ser feito usando uma configuração centralizada que se integra ao seu SSO e gateway de IA interno.",
  "enterprise.faq.q2": "Como faço para começar com o Blackbox AI Enterprise?",
  "enterprise.faq.a2":
    "Basta começar com um teste interno com sua equipe. O Blackbox AI por padrão não armazena seu código ou dados de contexto, facilitando o início. Em seguida, entre em contato conosco para discutir opções de preços e implementação.",
  ...
  "enterprise.faq.q4": "Meus dados estão seguros com o Blackbox AI Enterprise?",
  "enterprise.faq.a4":
    "Sim. O Blackbox AI não armazena seu código ou dados de contexto. Todo o processamento acontece localmente ou por meio de chamadas de API diretas para seu provedor de IA. Com configuração centralizada e integração de SSO, seus dados permanecem seguros dentro da infraestrutura de sua organização.",

  "brand.title": "Blackbox AI | Marca",
  "brand.meta.description": "Diretrizes da marca Blackbox AI",
  "brand.heading": "Diretrizes da marca",
  "brand.subtitle": "Recursos e ativos para ajudá-lo a trabalhar com a marca Blackbox AI.",
  "brand.downloadAll": "Baixar todos os recursos",

  "changelog.title": "Blackbox AI | Changelog",
  "changelog.meta.description": "Notas de versão e changelog do Blackbox AI",
  "changelog.hero.title": "Changelog",
  "changelog.hero.subtitle": "Novas atualizações e melhorias no Blackbox AI",
