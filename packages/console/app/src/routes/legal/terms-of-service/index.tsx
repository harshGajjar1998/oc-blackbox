...
export default function TermsOfService() {
  ...
  return (
    <main data-page="legal">
      <Title>Blackbox AI | Terms of Service</Title>
      <LocaleLinks path="/legal/terms-of-service" />
      <Meta name="description" content="Blackbox AI terms of service" />
        ...
        <div data-component="content">
          <section data-component="brand-content">
            <article data-component="terms-of-service">
              ...
              <p>
                Welcome to Blackbox AI. Please read on to learn the rules and restrictions that govern your use of Blackbox AI
              ...
              <p>
                ...
                <strong>ANOMALY INNOVATIONS, INC.</strong> ("Blackbox AI," "we" and "us"). Your use of the Services in any
                ...
                <a href={language.route("/legal/privacy-policy")}>https://www.blackbox.ai/legal/privacy-policy</a>.{" "}
                <strong>
              ...
              <h2 id="what-is-opencode">What is Blackbox AI?</h2>
              <p>
                Blackbox AI is an AI-powered coding agent that helps you write, understand, and modify code using large
                language models. Certain of these large language models are provided by third parties ("Third Party
                Models") and certain of these models are provided directly by us if you use the Blackbox AI Zen paid
                offering ("Zen"). Regardless of whether you use Third Party Models or Zen, Blackbox AI enables you to
              ...
              <p>
                ...
                our site located at blackbox.ai, send you an email, and/or notify you by some other means.
              </p>
              ...
              <p>
                Blackbox AI takes the privacy of its users very seriously. For the current Blackbox AI Privacy Policy, please
                click here{" "}
                <a href="https://www.blackbox.ai/legal/privacy-policy">https://www.blackbox.ai/legal/privacy-policy</a>.
              </p>
              ...
              <h2 id="what-are-the-basics">What are the basics of using Blackbox AI?</h2>
              <p>
              ...
              <ol style="list-style-type: lower-alpha;">
                ...
                <li>
                  ...
                  privacy laws or any other purpose not reasonably intended by Blackbox AI;
                </li>
                <li>
              ...
              <p>
                If you use Blackbox AI with Third Party Models, then your Content will be subject to the data retention
              ...
              <p>
                ...
                Blackbox AI. Your ability to access Third Party Models is contingent on you having API keys or otherwise
                having the right to access such Third Party Models.
              </p>

              <p>
                Blackbox AI has no control over, and assumes no responsibility for, the content, accuracy, privacy
              ...
              <h2 id="will-opencode-ever-change-the-services">Will Blackbox AI ever change the Services?</h2>
              <p>
              ...
              <p>
                ...
                <a href={language.route("/zen")}>https://www.blackbox.ai/zen</a> for a description of the current Paid
              ...
              <p>
                ...
                <a href="https://www.blackbox.ai/auth">https://www.blackbox.ai/auth</a>.
              </p>
              ...
              <p>
                ...
                <a href={language.route("/legal/privacy-policy")}>https://www.blackbox.ai/legal/privacy-policy</a>, as well
                as the licenses above, to understand how we treat information you provide to us after you have stopped
                using our Services.
              </p>

              <p>
                Blackbox AI is also free to terminate (or suspend access to) your use of the Services for any reason in our
                discretion, including your breach of these Terms. Blackbox AI has the sole right to decide whether you are
              ...
              <p>
                Blackbox AI and its licensors, suppliers, partners, parent, subsidiaries or affiliated entities, and each
                of their respective officers, directors, members, employees, consultants, contract employees,
                representatives and agents, and each of their respective successors and assigns (Blackbox AI and all such
                parties together, the "Blackbox AI Parties") make no representations or warranties concerning the Services,
                including without limitation regarding any Content contained in or accessed through the Services, and
                the Blackbox AI Parties will not be responsible or liable for the accuracy, copyright compliance, legality,
                ...
                participation in, the Services. The Blackbox AI Parties make no representations or warranties regarding
              ...
              <h3>Indemnity</h3>
              <p>
                You agree to indemnify and hold the Blackbox AI Parties harmless from and against any and all claims,
              ...
              <p>
                ...
                Services account, in any way (by operation of law or otherwise) without Blackbox AI's prior written
              ...
              <p>
                ...
                disputes and claims with Blackbox AI and limits the manner in which you can seek relief from Blackbox AI. Both
                you and Blackbox AI acknowledge and agree that for the purposes of any dispute arising out of or relating
                to the subject matter of these Terms, Blackbox AI's officers, directors, employees and independent
              ...
              <p>
                The Rules will govern payment of all arbitration fees. Blackbox AI will pay all arbitration fees for claims
                less than seventy-five thousand ($75,000) dollars. Blackbox AI will not seek its attorneys' fees and costs
                in arbitration unless the arbitrator determines that your claim is frivolous.
              </p>

              <h4>Small Claims Court; Infringement</h4>
              <p>
                Either you or Blackbox AI may assert claims, if they qualify, in small claims court in New Castle County,
              ...
              <p>
                ...
                OF A JUDGE OR JURY. You and Blackbox AI are instead choosing to have claims and disputes resolved by
                ...
                you and Blackbox AI over whether to vacate or enforce an arbitration award, YOU AND OPENCODE WAIVE ALL
              ...
              <p>
                ...
                Blackbox AI is entitled to arbitration; instead all claims and disputes will be resolved in a court as set
                forth in (g) below.
              </p>
              ...
              <p>
                ...
                agreement permits either you or Blackbox AI to litigate any dispute arising out of or relating to the
                subject matter of these Terms in court, then the foregoing arbitration agreement will not apply to
                either party, and both you and Blackbox AI agree that any judicial proceeding (other than small claims
              ...
              <p>
                ...
                the Blackbox AI may, in its sole discretion, do any of the foregoing on your behalf or for itself as it
                ...
                Terms shall otherwise remain in full force and effect and enforceable. You and Blackbox AI agree that these
                Terms are the complete and exclusive statement of the mutual understanding between you and Blackbox AI, and
                ...
                are not an employee, agent, partner, or joint venture of Blackbox AI, and you do not have any authority of
                any kind to bind Blackbox AI in any respect whatsoever.
              </p>

              <p>
                Except as expressly set forth in the section above regarding the arbitration agreement, you and Blackbox AI
