...
const createPlatform = (): Platform => {
  ...
  return {
    ...
    async openPath(path: string, app?: string) {
      const os = typeof window !== "undefined" && "__TAURI_INTERNALS__" in window ? ostype() : undefined
      if (os === "windows") {
    ...
    update: async () => {
      ...
      if (typeof window !== "undefined" && "__TAURI_INTERNALS__" in window && ostype() === "windows")
