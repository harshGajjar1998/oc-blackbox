export const dict = {
  ...
  "desktop.updater.none.message": "Ya estás usando la versión más reciente de Blackbox",
  ...
  "desktop.updater.downloaded.prompt":
    "Se ha descargado la versión {{version}} de Blackbox. ¿Quieres instalarla y reiniciar?",
