export const dict = {
  ...
  "desktop.updater.none.message": "أنت تستخدم بالفعل أحدث إصدار من Blackbox AI",
  ...
  "desktop.updater.downloaded.prompt": "تم تنزيل إصدار {{version}} من Blackbox AI، هل ترغب في تثبيته وإعادة تشغيله؟",
