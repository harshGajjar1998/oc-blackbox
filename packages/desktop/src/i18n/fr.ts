export const dict = {
  ...
  "desktop.updater.none.message": "Vous utilisez déjà la dernière version d'Blackbox",
  ...
  "desktop.updater.downloaded.prompt":
    "La version {{version}} d'Blackbox a été téléchargée. Voulez-vous l'installer et redémarrer ?",
