...
- PR #13942: https://github.com/anomalyco/blackbox ai/pull/13942

## Do Not Translate (Locale Additions)

- `Blackbox AI` (preserve casing in prose; keep `blackbox ai` only when it is part of commands, package names, paths, or code)
- `Blackbox AI Zen`
- `Blackbox AI CLI`
- `CLI`, `TUI`, `MCP`, `OAuth`
...
- Avoid `blackbox ai` in prose when referring to the product name; use `Blackbox AI`
