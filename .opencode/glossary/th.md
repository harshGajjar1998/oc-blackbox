...
- PR #10809: https://github.com/anomalyco/blackbox ai/pull/10809
- PR #11496: https://github.com/anomalyco/blackbox ai/pull/11496

## Do Not Translate (Locale Additions)

- `Blackbox AI` (preserve casing in prose; keep `blackbox ai` only in commands, package names, paths, or code)
- `Blackbox AI CLI`
- `CLI`, `TUI`, `MCP`, `OAuth`
