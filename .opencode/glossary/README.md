...
Use this folder for locale-specific translation guidance that supplements `.blackbox ai/agent/translator.md`.
...
- PR #12345: https://github.com/anomalyco/blackbox ai/pull/12345

## Do Not Translate (Locale Additions)

- `Blackbox AI` (preserve casing)
