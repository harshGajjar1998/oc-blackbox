...
function useShareUrl() {
  return isMock() ? "https://dev.blackbox.ai" : "https://www.blackbox.ai"
}
...
async function getAccessToken() {
  ...
  let response
  if (isMock()) {
    response = await fetch("https://api.blackbox.ai/exchange_github_app_token_with_pat", {
      method: "POST",
      headers: {
    ...
    response = await fetch("https://api.blackbox.ai/exchange_github_app_token", {
      method: "POST",
      headers: {
